...
proc ScriptShapeOpenType*(hdc: HDC, psc: ptr SCRIPT_CACHE, psa: ptr SCRIPT_ANALYSIS, tagScript: OPENTYPE_TAG, tagLangSys: OPENTYPE_TAG, rcRangeChars: ptr int32, rpRangeProperties: ptr ptr TEXTRANGE_PROPERTIES, cRanges: int32, pwcChars: ptr WCHAR, cChars: int32, cMaxGlyphs: int32, pwLogClust: ptr WORD, pCharProps: ptr SCRIPT_CHARPROP, pwOutGlyphs: ptr WORD, pOutGlyphProps: ptr SCRIPT_GLYPHPROP, pcGlyphs: ptr int32): HRESULT {.winapi, xpincompatible, stdcall, dynlib: "usp10", importc.}
proc ScriptPlaceOpenType*(hdc: HDC, psc: ptr SCRIPT_CACHE, psa: ptr SCRIPT_ANALYSIS, tagScript: OPENTYPE_TAG, tagLangSys: OPENTYPE_TAG, rcRangeChars: ptr int32, rpRangeProperties: ptr ptr TEXTRANGE_PROPERTIES, cRanges: int32, pwcChars: ptr WCHAR, pwLogClust: ptr WORD, pCharProps: ptr SCRIPT_CHARPROP, cChars: int32, pwGlyphs: ptr WORD, pGlyphProps: ptr SCRIPT_GLYPHPROP, cGlyphs: int32, piAdvance: ptr int32, pGoffset: ptr GOFFSET, pABC: ptr ABC): HRESULT {.winapi, xpincompatible, stdcall, dynlib: "usp10", importc.}
proc ScriptItemizeOpenType*(pwcInChars: ptr WCHAR, cInChars: int32, cMaxItems: int32, psControl: ptr SCRIPT_CONTROL, psState: ptr SCRIPT_STATE, pItems: ptr SCRIPT_ITEM, pScriptTags: ptr OPENTYPE_TAG, pcItems: ptr int32): HRESULT {.winapi, xpincompatible, stdcall, dynlib: "usp10", importc.}
proc ScriptGetFontScriptTags*(hdc: HDC, psc: ptr SCRIPT_CACHE, psa: ptr SCRIPT_ANALYSIS, cMaxTags: int32, pScriptTags: ptr OPENTYPE_TAG, pcTags: ptr int32): HRESULT {.winapi, xpincompatible, stdcall, dynlib: "usp10", importc.}
proc ScriptGetFontLanguageTags*(hdc: HDC, psc: ptr SCRIPT_CACHE, psa: ptr SCRIPT_ANALYSIS, tagScript: OPENTYPE_TAG, cMaxTags: int32, pLangsysTags: ptr OPENTYPE_TAG, pcTags: ptr int32): HRESULT {.winapi, xpincompatible, stdcall, dynlib: "usp10", importc.}
proc ScriptGetFontFeatureTags*(hdc: HDC, psc: ptr SCRIPT_CACHE, psa: ptr SCRIPT_ANALYSIS, tagScript: OPENTYPE_TAG, tagLangSys: OPENTYPE_TAG, cMaxTags: int32, pFeatureTags: ptr OPENTYPE_TAG, pcTags: ptr int32): HRESULT {.winapi, xpincompatible, stdcall, dynlib: "usp10", importc.}
proc ScriptGetFontAlternateGlyphs*(hdc: HDC, psc: ptr SCRIPT_CACHE, psa: ptr SCRIPT_ANALYSIS, tagScript: OPENTYPE_TAG, tagLangSys: OPENTYPE_TAG, tagFeature: OPENTYPE_TAG, wGlyphId: WORD, cMaxAlternates: int32, pAlternateGlyphs: ptr WORD, pcAlternates: ptr int32): HRESULT {.winapi, xpincompatible, stdcall, dynlib: "usp10", importc.}
proc ScriptSubstituteSingleGlyph*(hdc: HDC, psc: ptr SCRIPT_CACHE, psa: ptr SCRIPT_ANALYSIS, tagScript: OPENTYPE_TAG, tagLangSys: OPENTYPE_TAG, tagFeature: OPENTYPE_TAG, lParameter: LONG, wGlyphId: WORD, pwOutGlyphId: ptr WORD): HRESULT {.winapi, xpincompatible, stdcall, dynlib: "usp10", importc.}
proc ScriptPositionSingleGlyph*(hdc: HDC, psc: ptr SCRIPT_CACHE, psa: ptr SCRIPT_ANALYSIS, tagScript: OPENTYPE_TAG, tagLangSys: OPENTYPE_TAG, tagFeature: OPENTYPE_TAG, lParameter: LONG, wGlyphId: WORD, iAdvance: int32, GOffset: GOFFSET, piOutAdvance: ptr int32, pOutGoffset: ptr GOFFSET): HRESULT {.winapi, xpincompatible, stdcall, dynlib: "usp10", importc.}
