...
const
  ...
  IID_IAVIFile* = DEFINE_GUID(0x00020020'i32, 0, 0, [0xC0'u8, 0, 0, 0, 0, 0, 0, 0x46])
  IID_IAVIStream* = DEFINE_GUID(0x00020021'i32, 0, 0, [0xC0'u8, 0, 0, 0, 0, 0, 0, 0x46])
  IID_IAVIStreaming* = DEFINE_GUID(0x00020022'i32, 0, 0, [0xC0'u8, 0, 0, 0, 0, 0, 0, 0x46])
  IID_IGetFrame* = DEFINE_GUID(0x00020023'i32, 0, 0, [0xC0'u8, 0, 0, 0, 0, 0, 0, 0x46])
  IID_IAVIEditStream* = DEFINE_GUID(0x00020024'i32, 0, 0, [0xC0'u8, 0, 0, 0, 0, 0, 0, 0x46])
  IID_IAVIPersistFile* = DEFINE_GUID(0x00020025'i32, 0, 0, [0xC0'u8, 0, 0, 0, 0, 0, 0, 0x46])
  CLSID_AVIFile* = DEFINE_GUID(0x00020000'i32, 0, 0, [0xC0'u8, 0, 0, 0, 0, 0, 0, 0x46])
...
proc Create*(self: ptr IAVIStream, lParam1: LPARAM, lParam2: LPARAM): HRESULT {.winapi, inline.} = self.lpVtbl.Create(self, lParam1, lParam2)
proc Info*(self: ptr IAVIStream, psi: ptr TAVISTREAMINFOW, lSize: LONG): HRESULT {.winapi, inline.} = self.lpVtbl.Info(self, psi, lSize)
proc FindSample*(self: ptr IAVIStream, lPos: LONG, lFlags: LONG): LONG {.winapi, inline.} = self.lpVtbl.FindSample(self, lPos, lFlags)
proc ReadFormat*(self: ptr IAVIStream, lPos: LONG, lpFormat: LPVOID, lpcbFormat: ptr LONG): HRESULT {.winapi, inline.} = self.lpVtbl.ReadFormat(self, lPos, lpFormat, lpcbFormat)
proc SetFormat*(self: ptr IAVIStream, lPos: LONG, lpFormat: LPVOID, cbFormat: LONG): HRESULT {.winapi, inline.} = self.lpVtbl.SetFormat(self, lPos, lpFormat, cbFormat)
proc Read*(self: ptr IAVIStream, lStart: LONG, lSamples: LONG, lpBuffer: LPVOID, cbBuffer: LONG, plBytes: ptr LONG, plSamples: ptr LONG): HRESULT {.winapi, inline.} = self.lpVtbl.Read(self, lStart, lSamples, lpBuffer, cbBuffer, plBytes, plSamples)
proc Write*(self: ptr IAVIStream, lStart: LONG, lSamples: LONG, lpBuffer: LPVOID, cbBuffer: LONG, dwFlags: DWORD, plSampWritten: ptr LONG, plBytesWritten: ptr LONG): HRESULT {.winapi, inline.} = self.lpVtbl.Write(self, lStart, lSamples, lpBuffer, cbBuffer, dwFlags, plSampWritten, plBytesWritten)
proc mDelete*(self: ptr IAVIStream, lStart: LONG, lSamples: LONG): HRESULT {.winapi, inline.} = self.lpVtbl.Delete(self, lStart, lSamples)
proc ReadData*(self: ptr IAVIStream, fcc: DWORD, lp: LPVOID, lpcb: ptr LONG): HRESULT {.winapi, inline.} = self.lpVtbl.ReadData(self, fcc, lp, lpcb)
proc WriteData*(self: ptr IAVIStream, fcc: DWORD, lp: LPVOID, cb: LONG): HRESULT {.winapi, inline.} = self.lpVtbl.WriteData(self, fcc, lp, cb)
proc SetInfo*(self: ptr IAVIStream, lpInfo: ptr TAVISTREAMINFOW, cbInfo: LONG): HRESULT {.winapi, inline.} = self.lpVtbl.SetInfo(self, lpInfo, cbInfo)
proc Begin*(self: ptr IAVIStreaming, lStart: LONG, lEnd: LONG, lRate: LONG): HRESULT {.winapi, inline.} = self.lpVtbl.Begin(self, lStart, lEnd, lRate)
proc End*(self: ptr IAVIStreaming): HRESULT {.winapi, inline.} = self.lpVtbl.End(self)
proc Cut*(self: ptr IAVIEditStream, plStart: ptr LONG, plLength: ptr LONG, ppResult: ptr PAVISTREAM): HRESULT {.winapi, inline.} = self.lpVtbl.Cut(self, plStart, plLength, ppResult)
proc Copy*(self: ptr IAVIEditStream, plStart: ptr LONG, plLength: ptr LONG, ppResult: ptr PAVISTREAM): HRESULT {.winapi, inline.} = self.lpVtbl.Copy(self, plStart, plLength, ppResult)
proc Paste*(self: ptr IAVIEditStream, plPos: ptr LONG, plLength: ptr LONG, pstream: PAVISTREAM, lStart: LONG, lEnd: LONG): HRESULT {.winapi, inline.} = self.lpVtbl.Paste(self, plPos, plLength, pstream, lStart, lEnd)
proc Clone*(self: ptr IAVIEditStream, ppResult: ptr PAVISTREAM): HRESULT {.winapi, inline.} = self.lpVtbl.Clone(self, ppResult)
proc SetInfo*(self: ptr IAVIEditStream, lpInfo: ptr TAVISTREAMINFOW, cbInfo: LONG): HRESULT {.winapi, inline.} = self.lpVtbl.SetInfo(self, lpInfo, cbInfo)
proc Reserved1*(self: ptr IAVIPersistFile): HRESULT {.winapi, inline.} = self.lpVtbl.Reserved1(self)
proc Info*(self: ptr IAVIFile, pfi: ptr TAVIFILEINFOW, lSize: LONG): HRESULT {.winapi, inline.} = self.lpVtbl.Info(self, pfi, lSize)
proc GetStream*(self: ptr IAVIFile, ppStream: ptr PAVISTREAM, fccType: DWORD, lParam: LONG): HRESULT {.winapi, inline.} = self.lpVtbl.GetStream(self, ppStream, fccType, lParam)
proc CreateStream*(self: ptr IAVIFile, ppStream: ptr PAVISTREAM, psi: ptr TAVISTREAMINFOW): HRESULT {.winapi, inline.} = self.lpVtbl.CreateStream(self, ppStream, psi)
proc WriteData*(self: ptr IAVIFile, ckid: DWORD, lpData: LPVOID, cbData: LONG): HRESULT {.winapi, inline.} = self.lpVtbl.WriteData(self, ckid, lpData, cbData)
proc ReadData*(self: ptr IAVIFile, ckid: DWORD, lpData: LPVOID, lpcbData: ptr LONG): HRESULT {.winapi, inline.} = self.lpVtbl.ReadData(self, ckid, lpData, lpcbData)
proc EndRecord*(self: ptr IAVIFile): HRESULT {.winapi, inline.} = self.lpVtbl.EndRecord(self)
proc DeleteStream*(self: ptr IAVIFile, fccType: DWORD, lParam: LONG): HRESULT {.winapi, inline.} = self.lpVtbl.DeleteStream(self, fccType, lParam)
proc GetFrame*(self: ptr IGetFrame, lPos: LONG): LPVOID {.winapi, inline.} = self.lpVtbl.GetFrame(self, lPos)
...
when winimAnsi:
  ...
  const
    CLSID_AVISimpleUnMarshal* = DEFINE_GUID(0x00020009'i32, 0, 0, [0xC0'u8, 0, 0, 0, 0, 0, 0, 0x46])
