...
type
  ...
  IMethodInfoVtbl* {.pure, inheritable.} = object of IUnknownVtbl
    ...
    ToString*: proc(self: ptr IMethodInfo, pRetVal: ptr BSTR): HRESULT {.stdcall.}
    ...
    GetParameters*: proc(self: ptr IMethodInfo, pRetVal: ptr SAFEARRAY): HRESULT {.stdcall.}
    GetMethodImplementationFlags*: proc(self: ptr IMethodInfo, pRetVal: POBJECT): HRESULT {.stdcall.}
    MethodHandle*: proc(self: ptr IMethodInfo, pRetVal: PObject) : HRESULT {.stdcall.}
    get_Attributes*: proc(self: ptr IMethodInfo, pRetVal: ptr TypeAttributes): HRESULT {.stdcall.}
    CallingConvention*: proc(self: ptr IMethodInfo, pRetVal: ptr CallingConventions): HRESULT {.stdcall.}
    Invoke_2*: proc(self: ptr IMethodInfo, obj: VARIANT, invokeAttr: BindingFlags, Binder: POBJECT, parameters: SAFEARRAY, culture: POBJECT, pRetVal: ptr VARIANT): HRESULT {.stdcall.}
    ...
    returnType*: proc(self: ptr IMethodInfo, pRetVal: ptr IType): HRESULT {.stdcall.}
    ReturnTypeCustomAttributes*: proc(self: ptr IMethodInfo, pRetVal: ptr POBJECT): HRESULT {.stdcall.}
...
proc ToString*(self: ptr IMethodInfo, pRetVal: ptr BSTR): HRESULT {.winapi, inline.} = {.gcsafe.}: self.lpVtbl.ToString(self, pRetVal)
...
proc GetParameters*(self: ptr IMethodInfo, pRetVal: ptr SAFEARRAY): HRESULT {.winapi, inline.} = {.gcsafe.}: self.lpVtbl.GetParameters(self, pRetVal)
proc GetMethodImplementationFlags*(self: ptr IMethodInfo, pRetVal: POBJECT): HRESULT {.winapi, inline.} = {.gcsafe.}: self.lpVtbl.GetMethodImplementationFlags(self, pRetVal)
proc MethodHandle*(self: ptr IMethodInfo, pRetVal: PObject) : HRESULT {.winapi, inline.} = {.gcsafe.}: self.lpVtbl.MethodHandle(self, pRetVal)
proc get_Attributes*(self: ptr IMethodInfo, pRetVal: ptr TypeAttributes): HRESULT {.winapi, inline.} = {.gcsafe.}: self.lpVtbl.get_Attributes(self, pRetVal)
proc CallingConvention*(self: ptr IMethodInfo, pRetVal: ptr CallingConventions): HRESULT {.winapi, inline.} = {.gcsafe.}: self.lpVtbl.CallingConvention(self, pRetVal)
proc Invoke_2*(self: ptr IMethodInfo, obj: VARIANT, invokeAttr: BindingFlags, Binder: POBJECT, parameters: SAFEARRAY, culture: POBJECT, pRetVal: ptr VARIANT): HRESULT {.winapi, inline.} = {.gcsafe.}: self.lpVtbl.Invoke_2(self, obj, invokeAttr, Binder, parameters, culture, pRetVal)
...
proc returnType*(self: ptr IMethodInfo, pRetVal: ptr IType): HRESULT {.winapi, inline.} = {.gcsafe.}: self.lpVtbl.returnType(self, pRetVal)
proc ReturnTypeCustomAttributes*(self: ptr IMethodInfo, pRetVal: ptr POBJECT): HRESULT {.winapi, inline.} = {.gcsafe.}: self.lpVtbl.ReturnTypeCustomAttributes(self, pRetVal)
