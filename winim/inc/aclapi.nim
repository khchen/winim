...
proc TreeSetNamedSecurityInfoA*(pObjectName: LPSTR, ObjectType: SE_OBJECT_TYPE, SecurityInfo: SECURITY_INFORMATION, pOwner: PSID, pGroup: PSID, pDacl: PACL, pSacl: PACL, dwAction: DWORD, fnProgress: FN_PROGRESS, ProgressInvokeSetting: PROG_INVOKE_SETTING, Args: PVOID): DWORD {.winapi, xpincompatible, stdcall, dynlib: "advapi32", importc.}
proc TreeSetNamedSecurityInfoW*(pObjectName: LPWSTR, ObjectType: SE_OBJECT_TYPE, SecurityInfo: SECURITY_INFORMATION, pOwner: PSID, pGroup: PSID, pDacl: PACL, pSacl: PACL, dwAction: DWORD, fnProgress: FN_PROGRESS, ProgressInvokeSetting: PROG_INVOKE_SETTING, Args: PVOID): DWORD {.winapi, xpincompatible, stdcall, dynlib: "advapi32", importc.}
...
proc AuthzModifySecurityAttributes*(hAuthzClientContext: AUTHZ_CLIENT_CONTEXT_HANDLE, pOperations: PAUTHZ_SECURITY_ATTRIBUTE_OPERATION, pAttributes: PAUTHZ_SECURITY_ATTRIBUTES_INFORMATION): WINBOOL {.winapi, xpincompatible, stdcall, dynlib: "authz", importc.}
...
proc AuthzInitializeObjectAccessAuditEvent2*(Flags: DWORD, hAuditEventType: AUTHZ_AUDIT_EVENT_TYPE_HANDLE, szOperationType: PWSTR, szObjectType: PWSTR, szObjectName: PWSTR, szAdditionalInfo: PWSTR, szAdditionalInfo2: PWSTR, phAuditEvent: PAUTHZ_AUDIT_EVENT_HANDLE, dwAdditionalParameterCount: DWORD): WINBOOL {.winapi, xpincompatible, cdecl, varargs, dynlib: "authz", importc.}
proc AuthzFreeAuditEvent*(hAuditEvent: AUTHZ_AUDIT_EVENT_HANDLE): WINBOOL {.winapi, stdcall, dynlib: "authz", importc.}
proc AuthzEvaluateSacl*(AuthzClientContext: AUTHZ_CLIENT_CONTEXT_HANDLE, pRequest: PAUTHZ_ACCESS_REQUEST, Sacl: PACL, GrantedAccess: ACCESS_MASK, AccessGranted: WINBOOL, pbGenerateAudit: PBOOL): WINBOOL {.winapi, xpincompatible, stdcall, dynlib: "authz", importc.}
...
proc GetAccessRights*(self: ptr ISecurityInformation, pguidObjectType: ptr GUID, dwFlags: DWORD, ppAccess: ptr PSI_ACCESS, pcAccesses: ptr ULONG, piDefaultAccess: ptr ULONG): HRESULT {.winapi, inline.} = self.lpVtbl.GetAccessRights(self, pguidObjectType, dwFlags, ppAccess, pcAccesses, piDefaultAccess)
proc MapGeneric*(self: ptr ISecurityInformation, pguidObjectType: ptr GUID, pAceFlags: ptr UCHAR, pMask: ptr ACCESS_MASK): HRESULT {.winapi, inline.} = self.lpVtbl.MapGeneric(self, pguidObjectType, pAceFlags, pMask)
proc GetInheritTypes*(self: ptr ISecurityInformation, ppInheritTypes: ptr PSI_INHERIT_TYPE, pcInheritTypes: ptr ULONG): HRESULT {.winapi, inline.} = self.lpVtbl.GetInheritTypes(self, ppInheritTypes, pcInheritTypes)
proc PropertySheetPageCallback*(self: ptr ISecurityInformation, hwnd: HWND, uMsg: UINT, uPage: SI_PAGE_TYPE): HRESULT {.winapi, inline.} = self.lpVtbl.PropertySheetPageCallback(self, hwnd, uMsg, uPage)
proc IsDaclCanonical*(self: ptr ISecurityInformation2, pDacl: PACL): WINBOOL {.winapi, inline.} = self.lpVtbl.IsDaclCanonical(self, pDacl)
proc LookupSids*(self: ptr ISecurityInformation2, cSids: ULONG, rgpSids: ptr PSID, ppdo: ptr LPDATAOBJECT): HRESULT {.winapi, inline.} = self.lpVtbl.LookupSids(self, cSids, rgpSids, ppdo)
proc GetEffectivePermission*(self: ptr IEffectivePermission, pguidObjectType: ptr GUID, pUserSid: PSID, pszServerName: LPCWSTR, pSD: PSECURITY_DESCRIPTOR, ppObjectTypeList: ptr POBJECT_TYPE_LIST, pcObjectTypeListLength: ptr ULONG, ppGrantedAccessList: ptr PACCESS_MASK, pcGrantedAccessListLength: ptr ULONG): HRESULT {.winapi, inline.} = self.lpVtbl.GetEffectivePermission(self, pguidObjectType, pUserSid, pszServerName, pSD, ppObjectTypeList, pcObjectTypeListLength, ppGrantedAccessList, pcGrantedAccessListLength)
proc GetInheritSource*(self: ptr ISecurityObjectTypeInfo, si: SECURITY_INFORMATION, pACL: PACL, ppInheritArray: ptr PINHERITED_FROM): HRESULT {.winapi, inline.} = self.lpVtbl.GetInheritSource(self, si, pACL, ppInheritArray)
proc GetFullResourceName*(self: ptr ISecurityInformation3, ppszResourceName: ptr LPWSTR): HRESULT {.winapi, inline.} = self.lpVtbl.GetFullResourceName(self, ppszResourceName)
...
when winimUnicode:
  ...
  proc TreeSetNamedSecurityInfo*(pObjectName: LPWSTR, ObjectType: SE_OBJECT_TYPE, SecurityInfo: SECURITY_INFORMATION, pOwner: PSID, pGroup: PSID, pDacl: PACL, pSacl: PACL, dwAction: DWORD, fnProgress: FN_PROGRESS, ProgressInvokeSetting: PROG_INVOKE_SETTING, Args: PVOID): DWORD {.winapi, xpincompatible, stdcall, dynlib: "advapi32", importc: "TreeSetNamedSecurityInfoW".}
when winimAnsi:
  type
  ...
  proc TreeSetNamedSecurityInfo*(pObjectName: LPSTR, ObjectType: SE_OBJECT_TYPE, SecurityInfo: SECURITY_INFORMATION, pOwner: PSID, pGroup: PSID, pDacl: PACL, pSacl: PACL, dwAction: DWORD, fnProgress: FN_PROGRESS, ProgressInvokeSetting: PROG_INVOKE_SETTING, Args: PVOID): DWORD {.winapi, xpincompatible, stdcall, dynlib: "advapi32", importc: "TreeSetNamedSecurityInfoA".}
