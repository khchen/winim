...
const
  LIBID_Accessibility* = DEFINE_GUID(0x1ea4dbf0'i32, 0x3c3b, 0x11cf, [0x81'u8, 0x0c, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71])
  IID_IAccessibleHandler* = DEFINE_GUID(0x03022430'i32, 0xABC4, 0x11d0, [0xBD'u8, 0xE2, 0x00, 0xAA, 0x00, 0x1A, 0x19, 0x53])
  IID_IAccIdentity* = DEFINE_GUID(0x7852b78d'i32, 0x1cfd, 0x41c1, [0xa6'u8, 0x15, 0x9c, 0x0c, 0x85, 0x96, 0x0b, 0x5f])
  IID_IAccPropServer* = DEFINE_GUID(0x76c0dbbb'i32, 0x15e0, 0x4e7b, [0xb6'u8, 0x1b, 0x20, 0xee, 0xea, 0x20, 0x01, 0xe0])
  IID_IAccPropServices* = DEFINE_GUID(0x6e26e776'i32, 0x04f0, 0x495d, [0x80'u8, 0xe4, 0x33, 0x30, 0x35, 0x2e, 0x31, 0x69])
  IID_IAccPropMgrInternal* = DEFINE_GUID(0x2bd370a9'i32, 0x3e7f, 0x4edd, [0x8a'u8, 0x85, 0xf8, 0xfe, 0xd1, 0xf8, 0xe5, 0x1f])
  CLSID_AccPropServices* = DEFINE_GUID(0xb5f8350b'i32, 0x0548, 0x48b1, [0xa6'u8, 0xee, 0x88, 0xbd, 0x00, 0xb4, 0xa5, 0xe7])
  IIS_IsOleaccProxy* = DEFINE_GUID(0x902697fa'i32, 0x80e4, 0x4560, [0x80'u8, 0x2a, 0xa1, 0x3f, 0x22, 0xa6, 0x47, 0x09])
  MSAA_MENU_SIG* = 0xAA0DF00D'i32
  PROPID_ACC_NAME* = DEFINE_GUID(0x608d3df8'i32, 0x8128, 0x4aa7, [0xa4'u8, 0x28, 0xf5, 0x5e, 0x49, 0x26, 0x72, 0x91])
  PROPID_ACC_VALUE* = DEFINE_GUID(0x123fe443'i32, 0x211a, 0x4615, [0x95'u8, 0x27, 0xc4, 0x5a, 0x7e, 0x93, 0x71, 0x7a])
  PROPID_ACC_DESCRIPTION* = DEFINE_GUID(0x4d48dfe4'i32, 0xbd3f, 0x491f, [0xa6'u8, 0x48, 0x49, 0x2d, 0x6f, 0x20, 0xc5, 0x88])
  PROPID_ACC_ROLE* = DEFINE_GUID(0xcb905ff2'i32, 0x7bd1, 0x4c05, [0xb3'u8, 0xc8, 0xe6, 0xc2, 0x41, 0x36, 0x4d, 0x70])
  PROPID_ACC_STATE* = DEFINE_GUID(0xa8d4d5b0'i32, 0x0a21, 0x42d0, [0xa5'u8, 0xc0, 0x51, 0x4e, 0x98, 0x4f, 0x45, 0x7b])
  PROPID_ACC_HELP* = DEFINE_GUID(0xc831e11f'i32, 0x44db, 0x4a99, [0x97'u8, 0x68, 0xcb, 0x8f, 0x97, 0x8b, 0x72, 0x31])
  PROPID_ACC_KEYBOARDSHORTCUT* = DEFINE_GUID(0x7d9bceee'i32, 0x7d1e, 0x4979, [0x93'u8, 0x82, 0x51, 0x80, 0xf4, 0x17, 0x2c, 0x34])
  PROPID_ACC_DEFAULTACTION* = DEFINE_GUID(0x180c072b'i32, 0xc27f, 0x43c7, [0x99'u8, 0x22, 0xf6, 0x35, 0x62, 0xa4, 0x63, 0x2b])
  PROPID_ACC_HELPTOPIC* = DEFINE_GUID(0x787d1379'i32, 0x8ede, 0x440b, [0x8a'u8, 0xec, 0x11, 0xf7, 0xbf, 0x90, 0x30, 0xb3])
  PROPID_ACC_FOCUS* = DEFINE_GUID(0x6eb335df'i32, 0x1c29, 0x4127, [0xb1'u8, 0x2c, 0xde, 0xe9, 0xfd, 0x15, 0x7f, 0x2b])
  PROPID_ACC_SELECTION* = DEFINE_GUID(0xb99d073c'i32, 0xd731, 0x405b, [0x90'u8, 0x61, 0xd9, 0x5e, 0x8f, 0x84, 0x29, 0x84])
  PROPID_ACC_PARENT* = DEFINE_GUID(0x474c22b6'i32, 0xffc2, 0x467a, [0xb1'u8, 0xb5, 0xe9, 0x58, 0xb4, 0x65, 0x73, 0x30])
  PROPID_ACC_NAV_UP* = DEFINE_GUID(0x016e1a2b'i32, 0x1a4e, 0x4767, [0x86'u8, 0x12, 0x33, 0x86, 0xf6, 0x69, 0x35, 0xec])
  PROPID_ACC_NAV_DOWN* = DEFINE_GUID(0x031670ed'i32, 0x3cdf, 0x48d2, [0x96'u8, 0x13, 0x13, 0x8f, 0x2d, 0xd8, 0xa6, 0x68])
  PROPID_ACC_NAV_LEFT* = DEFINE_GUID(0x228086cb'i32, 0x82f1, 0x4a39, [0x87'u8, 0x05, 0xdc, 0xdc, 0x0f, 0xff, 0x92, 0xf5])
  PROPID_ACC_NAV_RIGHT* = DEFINE_GUID(0xcd211d9f'i32, 0xe1cb, 0x4fe5, [0xa7'u8, 0x7c, 0x92, 0x0b, 0x88, 0x4d, 0x09, 0x5b])
  PROPID_ACC_NAV_PREV* = DEFINE_GUID(0x776d3891'i32, 0xc73b, 0x4480, [0xb3'u8, 0xf6, 0x07, 0x6a, 0x16, 0xa1, 0x5a, 0xf6])
  PROPID_ACC_NAV_NEXT* = DEFINE_GUID(0x1cdc5455'i32, 0x8cd9, 0x4c92, [0xa3'u8, 0x71, 0x39, 0x39, 0xa2, 0xfe, 0x3e, 0xee])
  PROPID_ACC_NAV_FIRSTCHILD* = DEFINE_GUID(0xcfd02558'i32, 0x557b, 0x4c67, [0x84'u8, 0xf9, 0x2a, 0x09, 0xfc, 0xe4, 0x07, 0x49])
  PROPID_ACC_NAV_LASTCHILD* = DEFINE_GUID(0x302ecaa5'i32, 0x48d5, 0x4f8d, [0xb6'u8, 0x71, 0x1a, 0x8d, 0x20, 0xa7, 0x78, 0x32])
  PROPID_ACC_ROLEMAP* = DEFINE_GUID(0xf79acda2'i32, 0x140d, 0x4fe6, [0x89'u8, 0x14, 0x20, 0x84, 0x76, 0x32, 0x82, 0x69])
  PROPID_ACC_VALUEMAP* = DEFINE_GUID(0xda1c3d79'i32, 0xfc5c, 0x420e, [0xb3'u8, 0x99, 0x9d, 0x15, 0x33, 0x54, 0x9e, 0x75])
  PROPID_ACC_STATEMAP* = DEFINE_GUID(0x43946c5e'i32, 0x0ac0, 0x4042, [0xb5'u8, 0x25, 0x07, 0xbb, 0xdb, 0xe1, 0x7f, 0xa7])
  PROPID_ACC_DESCRIPTIONMAP* = DEFINE_GUID(0x1ff1435f'i32, 0x8a14, 0x477b, [0xb2'u8, 0x26, 0xa0, 0xab, 0xe2, 0x79, 0x97, 0x5d])
  PROPID_ACC_DODEFAULTACTION* = DEFINE_GUID(0x1ba09523'i32, 0x2e3b, 0x49a6, [0xa0'u8, 0x59, 0x59, 0x68, 0x2a, 0x3c, 0x48, 0xfd])
  NAVDIR_MIN* = 0
  NAVDIR_UP* = 0x1
  NAVDIR_DOWN* = 0x2
  NAVDIR_LEFT* = 0x3
  ...
  IID_IAccessible* = DEFINE_GUID(0x618736e0'i32, 0x3c3d, 0x11cf, [0x81'u8, 0x0c, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71])
  ANNO_THIS* = 0
  ANNO_CONTAINER* = 1
  ...
  IID_IObjectSafety* = DEFINE_GUID(0xcb5bdc81'i32, 0x93c1, 0x11cf, [0x8f'u8, 0x20, 0x0, 0x80, 0x5f, 0x2c, 0xd0, 0x64])
  CLSID_CFontPropPage* = DEFINE_GUID(0x0be35200'i32, 0x8f91, 0x11ce, [0x9d'u8, 0xe3, 0x00, 0xaa, 0x00, 0x4b, 0xb8, 0x51])
  CLSID_CColorPropPage* = DEFINE_GUID(0x0be35201'i32, 0x8f91, 0x11ce, [0x9d'u8, 0xe3, 0x00, 0xaa, 0x00, 0x4b, 0xb8, 0x51])
  CLSID_CPicturePropPage* = DEFINE_GUID(0x0be35202'i32, 0x8f91, 0x11ce, [0x9d'u8, 0xe3, 0x00, 0xaa, 0x00, 0x4b, 0xb8, 0x51])
  CLSID_PersistPropset* = DEFINE_GUID(0xfb8f0821'i32, 0x0164, 0x101b, [0x84'u8, 0xed, 0x08, 0x00, 0x2b, 0x2e, 0xc7, 0x13])
  CLSID_ConvertVBX* = DEFINE_GUID(0xfb8f0822'i32, 0x0164, 0x101b, [0x84'u8, 0xed, 0x08, 0x00, 0x2b, 0x2e, 0xc7, 0x13])
  CLSID_StdFont* = DEFINE_GUID(0x0be35203'i32, 0x8f91, 0x11ce, [0x9d'u8, 0xe3, 0x00, 0xaa, 0x00, 0x4b, 0xb8, 0x51])
  CLSID_StdPicture* = DEFINE_GUID(0x0be35204'i32, 0x8f91, 0x11ce, [0x9d'u8, 0xe3, 0x00, 0xaa, 0x00, 0x4b, 0xb8, 0x51])
  GUID_HIMETRIC* = DEFINE_GUID(0x66504300'i32, 0xBE0F, 0x101A, [0x8B'u8, 0xBB, 0x00, 0xAA, 0x00, 0x30, 0x0C, 0xAB])
  GUID_COLOR* = DEFINE_GUID(0x66504301'i32, 0xBE0F, 0x101A, [0x8B'u8, 0xBB, 0x00, 0xAA, 0x00, 0x30, 0x0C, 0xAB])
  GUID_XPOSPIXEL* = DEFINE_GUID(0x66504302'i32, 0xBE0F, 0x101A, [0x8B'u8, 0xBB, 0x00, 0xAA, 0x00, 0x30, 0x0C, 0xAB])
  GUID_YPOSPIXEL* = DEFINE_GUID(0x66504303'i32, 0xBE0F, 0x101A, [0x8B'u8, 0xBB, 0x00, 0xAA, 0x00, 0x30, 0x0C, 0xAB])
  GUID_XSIZEPIXEL* = DEFINE_GUID(0x66504304'i32, 0xBE0F, 0x101A, [0x8B'u8, 0xBB, 0x00, 0xAA, 0x00, 0x30, 0x0C, 0xAB])
  GUID_YSIZEPIXEL* = DEFINE_GUID(0x66504305'i32, 0xBE0F, 0x101A, [0x8B'u8, 0xBB, 0x00, 0xAA, 0x00, 0x30, 0x0C, 0xAB])
  GUID_XPOS* = DEFINE_GUID(0x66504306'i32, 0xBE0F, 0x101A, [0x8B'u8, 0xBB, 0x00, 0xAA, 0x00, 0x30, 0x0C, 0xAB])
  GUID_YPOS* = DEFINE_GUID(0x66504307'i32, 0xBE0F, 0x101A, [0x8B'u8, 0xBB, 0x00, 0xAA, 0x00, 0x30, 0x0C, 0xAB])
  GUID_XSIZE* = DEFINE_GUID(0x66504308'i32, 0xBE0F, 0x101A, [0x8B'u8, 0xBB, 0x00, 0xAA, 0x00, 0x30, 0x0C, 0xAB])
  GUID_YSIZE* = DEFINE_GUID(0x66504309'i32, 0xBE0F, 0x101A, [0x8B'u8, 0xBB, 0x00, 0xAA, 0x00, 0x30, 0x0C, 0xAB])
  GUID_TRISTATE* = DEFINE_GUID(0x6650430A'i32, 0xBE0F, 0x101A, [0x8B'u8, 0xBB, 0x00, 0xAA, 0x00, 0x30, 0x0C, 0xAB])
  GUID_OPTIONVALUEEXCLUSIVE* = DEFINE_GUID(0x6650430B'i32, 0xBE0F, 0x101A, [0x8B'u8, 0xBB, 0x00, 0xAA, 0x00, 0x30, 0x0C, 0xAB])
  GUID_CHECKVALUEEXCLUSIVE* = DEFINE_GUID(0x6650430C'i32, 0xBE0F, 0x101A, [0x8B'u8, 0xBB, 0x00, 0xAA, 0x00, 0x30, 0x0C, 0xAB])
  GUID_FONTNAME* = DEFINE_GUID(0x6650430D'i32, 0xBE0F, 0x101A, [0x8B'u8, 0xBB, 0x00, 0xAA, 0x00, 0x30, 0x0C, 0xAB])
  GUID_FONTSIZE* = DEFINE_GUID(0x6650430E'i32, 0xBE0F, 0x101A, [0x8B'u8, 0xBB, 0x00, 0xAA, 0x00, 0x30, 0x0C, 0xAB])
  GUID_FONTBOLD* = DEFINE_GUID(0x6650430F'i32, 0xBE0F, 0x101A, [0x8B'u8, 0xBB, 0x00, 0xAA, 0x00, 0x30, 0x0C, 0xAB])
  GUID_FONTITALIC* = DEFINE_GUID(0x66504310'i32, 0xBE0F, 0x101A, [0x8B'u8, 0xBB, 0x00, 0xAA, 0x00, 0x30, 0x0C, 0xAB])
  GUID_FONTUNDERSCORE* = DEFINE_GUID(0x66504311'i32, 0xBE0F, 0x101A, [0x8B'u8, 0xBB, 0x00, 0xAA, 0x00, 0x30, 0x0C, 0xAB])
  GUID_FONTSTRIKETHROUGH* = DEFINE_GUID(0x66504312'i32, 0xBE0F, 0x101A, [0x8B'u8, 0xBB, 0x00, 0xAA, 0x00, 0x30, 0x0C, 0xAB])
  GUID_HANDLE* = DEFINE_GUID(0x66504313'i32, 0xBE0F, 0x101A, [0x8B'u8, 0xBB, 0x00, 0xAA, 0x00, 0x30, 0x0C, 0xAB])
...
const
  ...
  CATID_ActiveScript* = DEFINE_GUID(0xf0b7a1a1'i32, 0x9847, 0x11cf, [0x8f'u8, 0x20, 0x00, 0x80, 0x5f, 0x2c, 0xd0, 0x64])
  CATID_ActiveScriptParse* = DEFINE_GUID(0xf0b7a1a2'i32, 0x9847, 0x11cf, [0x8f'u8, 0x20, 0x00, 0x80, 0x5f, 0x2c, 0xd0, 0x64])
  CATID_ActiveScriptEncode* = DEFINE_GUID(0xf0b7a1a3'i32, 0x9847, 0x11cf, [0x8f'u8, 0x20, 0x00, 0x80, 0x5f, 0x2c, 0xd0, 0x64])
  OID_VBSSIP* = DEFINE_GUID(0x1629f04e'i32, 0x2799, 0x4db5, [0x8f'u8, 0xe5, 0xac, 0xe1, 0x0f, 0x17, 0xeb, 0xab])
  OID_JSSIP* = DEFINE_GUID(0x6c9e010'i32, 0x38ce, 0x11d4, [0xa2'u8, 0xa3, 0x00, 0x10, 0x4b, 0xd3, 0x50, 0x90])
  OID_WSFSIP* = DEFINE_GUID(0x1a610570'i32, 0x38ce, 0x11d4, [0xa2'u8, 0xa3, 0x00, 0x10, 0x4b, 0xd3, 0x50, 0x90])
  ...
  IID_IActiveScriptSite* = DEFINE_GUID(0xdb01a1e3'i32, 0xa42b, 0x11cf, [0x8f'u8, 0x20, 0x00, 0x80, 0x5f, 0x2c, 0xd0, 0x64])
  IID_IActiveScriptError* = DEFINE_GUID(0xeae1ba61'i32, 0xa4ed, 0x11cf, [0x8f'u8, 0x20, 0x00, 0x80, 0x5f, 0x2c, 0xd0, 0x64])
  IID_IActiveScriptError64* = DEFINE_GUID(0xb21fb2a1'i32, 0x5b8f, 0x4963, [0x8c'u8, 0x21, 0x21, 0x45, 0x0f, 0x84, 0xed, 0x7f])
  IID_IActiveScriptSiteWindow* = DEFINE_GUID(0xd10f6761'i32, 0x83e9, 0x11cf, [0x8f'u8, 0x20, 0x00, 0x80, 0x5f, 0x2c, 0xd0, 0x64])
  IID_IActiveScriptSiteUIControl* = DEFINE_GUID(0xaedae97e'i32, 0xd7ee, 0x4796, [0xb9'u8, 0x60, 0x7f, 0x09, 0x2a, 0xe8, 0x44, 0xab])
  IID_IActiveScriptSiteInterruptPoll* = DEFINE_GUID(0x539698a0'i32, 0xcdca, 0x11cf, [0xa5'u8, 0xeb, 0x00, 0xaa, 0x00, 0x47, 0xa0, 0x63])
  IID_IActiveScript* = DEFINE_GUID(0xbb1a2ae1'i32, 0xa4f9, 0x11cf, [0x8f'u8, 0x20, 0x00, 0x80, 0x5f, 0x2c, 0xd0, 0x64])
  IID_IActiveScriptParse32* = DEFINE_GUID(0xbb1a2ae2'i32, 0xa4f9, 0x11cf, [0x8f'u8, 0x20, 0x00, 0x80, 0x5f, 0x2c, 0xd0, 0x64])
  IID_IActiveScriptParse64* = DEFINE_GUID(0xc7ef7658'i32, 0xe1ee, 0x480e, [0x97'u8, 0xea, 0xd5, 0x2c, 0xb4, 0xd7, 0x6d, 0x17])
  IID_IActiveScriptParseProcedureOld32* = DEFINE_GUID(0x1cff0050'i32, 0x6fdd, 0x11d0, [0x93'u8, 0x28, 0x00, 0xa0, 0xc9, 0x0d, 0xca, 0xa9])
  IID_IActiveScriptParseProcedureOld64* = DEFINE_GUID(0x21f57128'i32, 0x08c9, 0x4638, [0xba'u8, 0x12, 0x22, 0xd1, 0x5d, 0x88, 0xdc, 0x5c])
  IID_IActiveScriptParseProcedure32* = DEFINE_GUID(0xaa5b6a80'i32, 0xb834, 0x11d0, [0x93'u8, 0x2f, 0x00, 0xa0, 0xc9, 0x0d, 0xca, 0xa9])
  IID_IActiveScriptParseProcedure64* = DEFINE_GUID(0xc64713b6'i32, 0xe029, 0x4cc5, [0x92'u8, 0x00, 0x43, 0x8b, 0x72, 0x89, 0x0b, 0x6a])
  IID_IActiveScriptParseProcedure2_32* = DEFINE_GUID(0x71ee5b20'i32, 0xfb04, 0x11d1, [0xb3'u8, 0xa8, 0x00, 0xa0, 0xc9, 0x11, 0xe8, 0xb2])
  IID_IActiveScriptParseProcedure2_64* = DEFINE_GUID(0xfe7c4271'i32, 0x210c, 0x448d, [0x9f'u8, 0x54, 0x76, 0xda, 0xb7, 0x04, 0x7b, 0x28])
  IID_IActiveScriptEncode* = DEFINE_GUID(0xbb1a2ae3'i32, 0xa4f9, 0x11cf, [0x8f'u8, 0x20, 0x00, 0x80, 0x5f, 0x2c, 0xd0, 0x64])
  IID_IActiveScriptHostEncode* = DEFINE_GUID(0xbee9b76e'i32, 0xcfe3, 0x11d1, [0xb7'u8, 0x47, 0x00, 0xc0, 0x4f, 0xc2, 0xb0, 0x85])
  IID_IBindEventHandler* = DEFINE_GUID(0x63cdbcb0'i32, 0xc1b1, 0x11d0, [0x93'u8, 0x36, 0x00, 0xa0, 0xc9, 0x0d, 0xca, 0xa9])
  IID_IActiveScriptStats* = DEFINE_GUID(0xb8da6310'i32, 0xe19b, 0x11d0, [0x93'u8, 0x3c, 0x00, 0xa0, 0xc9, 0x0d, 0xca, 0xa9])
  IID_IActiveScriptProperty* = DEFINE_GUID(0x4954e0d0'i32, 0xfbc7, 0x11d1, [0x84'u8, 0x10, 0x00, 0x60, 0x08, 0xc3, 0xfb, 0xfc])
  IID_ITridentEventSink* = DEFINE_GUID(0x1dc9ca50'i32, 0x06ef, 0x11d2, [0x84'u8, 0x15, 0x00, 0x60, 0x08, 0xc3, 0xfb, 0xfc])
  IID_IActiveScriptGarbageCollector* = DEFINE_GUID(0x6aa2c4a0'i32, 0x2b53, 0x11d4, [0xa2'u8, 0xa0, 0x00, 0x10, 0x4b, 0xd3, 0x50, 0x90])
  IID_IActiveScriptSIPInfo* = DEFINE_GUID(0x764651d0'i32, 0x38de, 0x11d4, [0xa2'u8, 0xa3, 0x00, 0x10, 0x4b, 0xd3, 0x50, 0x90])
  IID_IActiveScriptSiteTraceInfo* = DEFINE_GUID(0x4b7272ae'i32, 0x1955, 0x4bfe, [0x98'u8, 0xb0, 0x78, 0x06, 0x21, 0x88, 0x85, 0x69])
  IID_IActiveScriptTraceInfo* = DEFINE_GUID(0xc35456e7'i32, 0xbebf, 0x4a1b, [0x86'u8, 0xa9, 0x24, 0xd5, 0x6b, 0xe8, 0xb3, 0x69])
  IID_IActiveScriptStringCompare* = DEFINE_GUID(0x58562769'i32, 0xed52, 0x42f7, [0x84'u8, 0x03, 0x49, 0x63, 0x51, 0x4e, 0x1f, 0x11])
  IDC_OLEUIHELP* = 99
...
proc get_accName*(self: ptr IAccessible, varID: VARIANT, pszName: ptr BSTR): HRESULT {.winapi, inline.} = self.lpVtbl.get_accName(self, varID, pszName)
proc get_accValue*(self: ptr IAccessible, varID: VARIANT, pszValue: ptr BSTR): HRESULT {.winapi, inline.} = self.lpVtbl.get_accValue(self, varID, pszValue)
proc get_accDescription*(self: ptr IAccessible, varID: VARIANT, pszDescription: ptr BSTR): HRESULT {.winapi, inline.} = self.lpVtbl.get_accDescription(self, varID, pszDescription)
proc get_accRole*(self: ptr IAccessible, varID: VARIANT, pvarRole: ptr VARIANT): HRESULT {.winapi, inline.} = self.lpVtbl.get_accRole(self, varID, pvarRole)
proc get_accState*(self: ptr IAccessible, varID: VARIANT, pvarState: ptr VARIANT): HRESULT {.winapi, inline.} = self.lpVtbl.get_accState(self, varID, pvarState)
proc get_accHelp*(self: ptr IAccessible, varID: VARIANT, pszHelp: ptr BSTR): HRESULT {.winapi, inline.} = self.lpVtbl.get_accHelp(self, varID, pszHelp)
proc get_accHelpTopic*(self: ptr IAccessible, pszHelpFile: ptr BSTR, varID: VARIANT, pidTopic: ptr LONG): HRESULT {.winapi, inline.} = self.lpVtbl.get_accHelpTopic(self, pszHelpFile, varID, pidTopic)
proc get_accKeyboardShortcut*(self: ptr IAccessible, varID: VARIANT, pszKeyboardShortcut: ptr BSTR): HRESULT {.winapi, inline.} = self.lpVtbl.get_accKeyboardShortcut(self, varID, pszKeyboardShortcut)
proc get_accFocus*(self: ptr IAccessible, pvarID: ptr VARIANT): HRESULT {.winapi, inline.} = self.lpVtbl.get_accFocus(self, pvarID)
proc get_accSelection*(self: ptr IAccessible, pvarID: ptr VARIANT): HRESULT {.winapi, inline.} = self.lpVtbl.get_accSelection(self, pvarID)
proc get_accDefaultAction*(self: ptr IAccessible, varID: VARIANT, pszDefaultAction: ptr BSTR): HRESULT {.winapi, inline.} = self.lpVtbl.get_accDefaultAction(self, varID, pszDefaultAction)
proc accSelect*(self: ptr IAccessible, flagsSelect: LONG, varID: VARIANT): HRESULT {.winapi, inline.} = self.lpVtbl.accSelect(self, flagsSelect, varID)
proc accLocation*(self: ptr IAccessible, pxLeft: ptr LONG, pyTop: ptr LONG, pcxWidth: ptr LONG, pcyHeight: ptr LONG, varID: VARIANT): HRESULT {.winapi, inline.} = self.lpVtbl.accLocation(self, pxLeft, pyTop, pcxWidth, pcyHeight, varID)
proc accNavigate*(self: ptr IAccessible, navDir: LONG, varStart: VARIANT, pvarEnd: ptr VARIANT): HRESULT {.winapi, inline.} = self.lpVtbl.accNavigate(self, navDir, varStart, pvarEnd)
proc accHitTest*(self: ptr IAccessible, xLeft: LONG, yTop: LONG, pvarID: ptr VARIANT): HRESULT {.winapi, inline.} = self.lpVtbl.accHitTest(self, xLeft, yTop, pvarID)
proc accDoDefaultAction*(self: ptr IAccessible, varID: VARIANT): HRESULT {.winapi, inline.} = self.lpVtbl.accDoDefaultAction(self, varID)
proc put_accName*(self: ptr IAccessible, varID: VARIANT, pszName: BSTR): HRESULT {.winapi, inline.} = self.lpVtbl.put_accName(self, varID, pszName)
proc put_accValue*(self: ptr IAccessible, varID: VARIANT, pszValue: BSTR): HRESULT {.winapi, inline.} = self.lpVtbl.put_accValue(self, varID, pszValue)
proc AccessibleObjectFromID*(self: ptr IAccessibleHandler, hwnd: LONG, lObjectID: LONG, pIAccessible: ptr LPACCESSIBLE): HRESULT {.winapi, inline.} = self.lpVtbl.AccessibleObjectFromID(self, hwnd, lObjectID, pIAccessible)
proc GetIdentityString*(self: ptr IAccIdentity, dwIDChild: DWORD, ppIDString: ptr ptr BYTE, pdwIDStringLen: ptr DWORD): HRESULT {.winapi, inline.} = self.lpVtbl.GetIdentityString(self, dwIDChild, ppIDString, pdwIDStringLen)
proc GetPropValue*(self: ptr IAccPropServer, pIDString: ptr BYTE, dwIDStringLen: DWORD, idProp: MSAAPROPID, pvarValue: ptr VARIANT, pfHasProp: ptr WINBOOL): HRESULT {.winapi, inline.} = self.lpVtbl.GetPropValue(self, pIDString, dwIDStringLen, idProp, pvarValue, pfHasProp)
proc SetPropValue*(self: ptr IAccPropServices, pIDString: ptr BYTE, dwIDStringLen: DWORD, idProp: MSAAPROPID, `var`: VARIANT): HRESULT {.winapi, inline.} = self.lpVtbl.SetPropValue(self, pIDString, dwIDStringLen, idProp, `var`)
proc SetPropServer*(self: ptr IAccPropServices, pIDString: ptr BYTE, dwIDStringLen: DWORD, paProps: ptr MSAAPROPID, cProps: int32, pServer: ptr IAccPropServer, annoScope: AnnoScope): HRESULT {.winapi, inline.} = self.lpVtbl.SetPropServer(self, pIDString, dwIDStringLen, paProps, cProps, pServer, annoScope)
proc ClearProps*(self: ptr IAccPropServices, pIDString: ptr BYTE, dwIDStringLen: DWORD, paProps: ptr MSAAPROPID, cProps: int32): HRESULT {.winapi, inline.} = self.lpVtbl.ClearProps(self, pIDString, dwIDStringLen, paProps, cProps)
proc SetHwndProp*(self: ptr IAccPropServices, hwnd: HWND, idObject: DWORD, idChild: DWORD, idProp: MSAAPROPID, `var`: VARIANT): HRESULT {.winapi, inline.} = self.lpVtbl.SetHwndProp(self, hwnd, idObject, idChild, idProp, `var`)
proc SetHwndPropStr*(self: ptr IAccPropServices, hwnd: HWND, idObject: DWORD, idChild: DWORD, idProp: MSAAPROPID, str: LPCWSTR): HRESULT {.winapi, inline.} = self.lpVtbl.SetHwndPropStr(self, hwnd, idObject, idChild, idProp, str)
proc SetHwndPropServer*(self: ptr IAccPropServices, hwnd: HWND, idObject: DWORD, idChild: DWORD, paProps: ptr MSAAPROPID, cProps: int32, pServer: ptr IAccPropServer, annoScope: AnnoScope): HRESULT {.winapi, inline.} = self.lpVtbl.SetHwndPropServer(self, hwnd, idObject, idChild, paProps, cProps, pServer, annoScope)
proc ClearHwndProps*(self: ptr IAccPropServices, hwnd: HWND, idObject: DWORD, idChild: DWORD, paProps: ptr MSAAPROPID, cProps: int32): HRESULT {.winapi, inline.} = self.lpVtbl.ClearHwndProps(self, hwnd, idObject, idChild, paProps, cProps)
proc ComposeHwndIdentityString*(self: ptr IAccPropServices, hwnd: HWND, idObject: DWORD, idChild: DWORD, ppIDString: ptr ptr BYTE, pdwIDStringLen: ptr DWORD): HRESULT {.winapi, inline.} = self.lpVtbl.ComposeHwndIdentityString(self, hwnd, idObject, idChild, ppIDString, pdwIDStringLen)
proc DecomposeHwndIdentityString*(self: ptr IAccPropServices, pIDString: ptr BYTE, dwIDStringLen: DWORD, phwnd: ptr HWND, pidObject: ptr DWORD, pidChild: ptr DWORD): HRESULT {.winapi, inline.} = self.lpVtbl.DecomposeHwndIdentityString(self, pIDString, dwIDStringLen, phwnd, pidObject, pidChild)
proc SetHmenuProp*(self: ptr IAccPropServices, hmenu: HMENU, idChild: DWORD, idProp: MSAAPROPID, `var`: VARIANT): HRESULT {.winapi, inline.} = self.lpVtbl.SetHmenuProp(self, hmenu, idChild, idProp, `var`)
proc SetHmenuPropStr*(self: ptr IAccPropServices, hmenu: HMENU, idChild: DWORD, idProp: MSAAPROPID, str: LPCWSTR): HRESULT {.winapi, inline.} = self.lpVtbl.SetHmenuPropStr(self, hmenu, idChild, idProp, str)
proc SetHmenuPropServer*(self: ptr IAccPropServices, hmenu: HMENU, idChild: DWORD, paProps: ptr MSAAPROPID, cProps: int32, pServer: ptr IAccPropServer, annoScope: AnnoScope): HRESULT {.winapi, inline.} = self.lpVtbl.SetHmenuPropServer(self, hmenu, idChild, paProps, cProps, pServer, annoScope)
proc ClearHmenuProps*(self: ptr IAccPropServices, hmenu: HMENU, idChild: DWORD, paProps: ptr MSAAPROPID, cProps: int32): HRESULT {.winapi, inline.} = self.lpVtbl.ClearHmenuProps(self, hmenu, idChild, paProps, cProps)
proc ComposeHmenuIdentityString*(self: ptr IAccPropServices, hmenu: HMENU, idChild: DWORD, ppIDString: ptr ptr BYTE, pdwIDStringLen: ptr DWORD): HRESULT {.winapi, inline.} = self.lpVtbl.ComposeHmenuIdentityString(self, hmenu, idChild, ppIDString, pdwIDStringLen)
proc DecomposeHmenuIdentityString*(self: ptr IAccPropServices, pIDString: ptr BYTE, dwIDStringLen: DWORD, phmenu: ptr HMENU, pidChild: ptr DWORD): HRESULT {.winapi, inline.} = self.lpVtbl.DecomposeHmenuIdentityString(self, pIDString, dwIDStringLen, phmenu, pidChild)
proc GetInterfaceSafetyOptions*(self: ptr IObjectSafety, riid: REFIID, pdwSupportedOptions: ptr DWORD, pdwEnabledOptions: ptr DWORD): HRESULT {.winapi, inline.} = self.lpVtbl.GetInterfaceSafetyOptions(self, riid, pdwSupportedOptions, pdwEnabledOptions)
proc SetInterfaceSafetyOptions*(self: ptr IObjectSafety, riid: REFIID, dwOptionSetMask: DWORD, dwEnabledOptions: DWORD): HRESULT {.winapi, inline.} = self.lpVtbl.SetInterfaceSafetyOptions(self, riid, dwOptionSetMask, dwEnabledOptions)
proc GetLCID*(self: ptr IActiveScriptSite, plcid: ptr LCID): HRESULT {.winapi, inline.} = self.lpVtbl.GetLCID(self, plcid)
...
proc GetExceptionInfo*(self: ptr IActiveScriptError, pexcepinfo: ptr EXCEPINFO): HRESULT {.winapi, inline.} = self.lpVtbl.GetExceptionInfo(self, pexcepinfo)
proc GetSourcePosition*(self: ptr IActiveScriptError, pdwSourceContext: ptr DWORD, pulLineNumber: ptr ULONG, plCharacterPosition: ptr LONG): HRESULT {.winapi, inline.} = self.lpVtbl.GetSourcePosition(self, pdwSourceContext, pulLineNumber, plCharacterPosition)
proc GetSourceLineText*(self: ptr IActiveScriptError, pbstrSourceLine: ptr BSTR): HRESULT {.winapi, inline.} = self.lpVtbl.GetSourceLineText(self, pbstrSourceLine)
proc GetSourcePosition64*(self: ptr IActiveScriptError64, pdwSourceContext: ptr DWORDLONG, pulLineNumber: ptr ULONG, plCharacterPosition: ptr LONG): HRESULT {.winapi, inline.} = self.lpVtbl.GetSourcePosition64(self, pdwSourceContext, pulLineNumber, plCharacterPosition)
proc GetWindow*(self: ptr IActiveScriptSiteWindow, phwnd: ptr HWND): HRESULT {.winapi, inline.} = self.lpVtbl.GetWindow(self, phwnd)
proc EnableModeless*(self: ptr IActiveScriptSiteWindow, fEnable: WINBOOL): HRESULT {.winapi, inline.} = self.lpVtbl.EnableModeless(self, fEnable)
proc GetUIBehavior*(self: ptr IActiveScriptSiteUIControl, UicItem: SCRIPTUICITEM, pUicHandling: ptr SCRIPTUICHANDLING): HRESULT {.winapi, inline.} = self.lpVtbl.GetUIBehavior(self, UicItem, pUicHandling)
...
proc GetScriptDispatch*(self: ptr IActiveScript, pstrItemName: LPCOLESTR, ppdisp: ptr ptr IDispatch): HRESULT {.winapi, inline.} = self.lpVtbl.GetScriptDispatch(self, pstrItemName, ppdisp)
proc GetCurrentScriptThreadID*(self: ptr IActiveScript, pstidThread: ptr SCRIPTTHREADID): HRESULT {.winapi, inline.} = self.lpVtbl.GetCurrentScriptThreadID(self, pstidThread)
proc GetScriptThreadID*(self: ptr IActiveScript, dwWin32ThreadId: DWORD, pstidThread: ptr SCRIPTTHREADID): HRESULT {.winapi, inline.} = self.lpVtbl.GetScriptThreadID(self, dwWin32ThreadId, pstidThread)
proc GetScriptThreadState*(self: ptr IActiveScript, stidThread: SCRIPTTHREADID, pstsState: ptr SCRIPTTHREADSTATE): HRESULT {.winapi, inline.} = self.lpVtbl.GetScriptThreadState(self, stidThread, pstsState)
proc InterruptScriptThread*(self: ptr IActiveScript, stidThread: SCRIPTTHREADID, pexcepinfo: ptr EXCEPINFO, dwFlags: DWORD): HRESULT {.winapi, inline.} = self.lpVtbl.InterruptScriptThread(self, stidThread, pexcepinfo, dwFlags)
proc Clone*(self: ptr IActiveScript, ppscript: ptr ptr IActiveScript): HRESULT {.winapi, inline.} = self.lpVtbl.Clone(self, ppscript)
proc InitNew*(self: ptr IActiveScriptParse32): HRESULT {.winapi, inline.} = self.lpVtbl.InitNew(self)
proc AddScriptlet*(self: ptr IActiveScriptParse32, pstrDefaultName: LPCOLESTR, pstrCode: LPCOLESTR, pstrItemName: LPCOLESTR, pstrSubItemName: LPCOLESTR, pstrEventName: LPCOLESTR, pstrDelimiter: LPCOLESTR, dwSourceContextCookie: DWORD, ulStartingLineNumber: ULONG, dwFlags: DWORD, pbstrName: ptr BSTR, pexcepinfo: ptr EXCEPINFO): HRESULT {.winapi, inline.} = self.lpVtbl.AddScriptlet(self, pstrDefaultName, pstrCode, pstrItemName, pstrSubItemName, pstrEventName, pstrDelimiter, dwSourceContextCookie, ulStartingLineNumber, dwFlags, pbstrName, pexcepinfo)
proc ParseScriptText*(self: ptr IActiveScriptParse32, pstrCode: LPCOLESTR, pstrItemName: LPCOLESTR, punkContext: ptr IUnknown, pstrDelimiter: LPCOLESTR, dwSourceContextCookie: DWORD, ulStartingLineNumber: ULONG, dwFlags: DWORD, pvarResult: ptr VARIANT, pexcepinfo: ptr EXCEPINFO): HRESULT {.winapi, inline.} = self.lpVtbl.ParseScriptText(self, pstrCode, pstrItemName, punkContext, pstrDelimiter, dwSourceContextCookie, ulStartingLineNumber, dwFlags, pvarResult, pexcepinfo)
proc InitNew*(self: ptr IActiveScriptParse64): HRESULT {.winapi, inline.} = self.lpVtbl.InitNew(self)
...
proc ParseProcedureText*(self: ptr IActiveScriptParseProcedure32, pstrCode: LPCOLESTR, pstrFormalParams: LPCOLESTR, pstrProcedureName: LPCOLESTR, pstrItemName: LPCOLESTR, punkContext: ptr IUnknown, pstrDelimiter: LPCOLESTR, dwSourceContextCookie: DWORD, ulStartingLineNumber: ULONG, dwFlags: DWORD, ppdisp: ptr ptr IDispatch): HRESULT {.winapi, inline.} = self.lpVtbl.ParseProcedureText(self, pstrCode, pstrFormalParams, pstrProcedureName, pstrItemName, punkContext, pstrDelimiter, dwSourceContextCookie, ulStartingLineNumber, dwFlags, ppdisp)
proc ParseProcedureText*(self: ptr IActiveScriptParseProcedure64, pstrCode: LPCOLESTR, pstrFormalParams: LPCOLESTR, pstrProcedureName: LPCOLESTR, pstrItemName: LPCOLESTR, punkContext: ptr IUnknown, pstrDelimiter: LPCOLESTR, dwSourceContextCookie: DWORDLONG, ulStartingLineNumber: ULONG, dwFlags: DWORD, ppdisp: ptr ptr IDispatch): HRESULT {.winapi, inline.} = self.lpVtbl.ParseProcedureText(self, pstrCode, pstrFormalParams, pstrProcedureName, pstrItemName, punkContext, pstrDelimiter, dwSourceContextCookie, ulStartingLineNumber, dwFlags, ppdisp)
proc EncodeSection*(self: ptr IActiveScriptEncode, pchIn: LPCOLESTR, cchIn: DWORD, pchOut: LPOLESTR, cchOut: DWORD, pcchRet: ptr DWORD): HRESULT {.winapi, inline.} = self.lpVtbl.EncodeSection(self, pchIn, cchIn, pchOut, cchOut, pcchRet)
proc DecodeScript*(self: ptr IActiveScriptEncode, pchIn: LPCOLESTR, cchIn: DWORD, pchOut: LPOLESTR, cchOut: DWORD, pcchRet: ptr DWORD): HRESULT {.winapi, inline.} = self.lpVtbl.DecodeScript(self, pchIn, cchIn, pchOut, cchOut, pcchRet)
proc GetEncodeProgId*(self: ptr IActiveScriptEncode, pbstrOut: ptr BSTR): HRESULT {.winapi, inline.} = self.lpVtbl.GetEncodeProgId(self, pbstrOut)
proc EncodeScriptHostFile*(self: ptr IActiveScriptHostEncode, bstrInFile: BSTR, pbstrOutFile: ptr BSTR, cFlags: ULONG, bstrDefaultLang: BSTR): HRESULT {.winapi, inline.} = self.lpVtbl.EncodeScriptHostFile(self, bstrInFile, pbstrOutFile, cFlags, bstrDefaultLang)
proc BindHandler*(self: ptr IBindEventHandler, pstrEvent: LPCOLESTR, pdisp: ptr IDispatch): HRESULT {.winapi, inline.} = self.lpVtbl.BindHandler(self, pstrEvent, pdisp)
proc GetStat*(self: ptr IActiveScriptStats, stid: DWORD, pluHi: ptr ULONG, pluLo: ptr ULONG): HRESULT {.winapi, inline.} = self.lpVtbl.GetStat(self, stid, pluHi, pluLo)
proc GetStatEx*(self: ptr IActiveScriptStats, guid: REFGUID, pluHi: ptr ULONG, pluLo: ptr ULONG): HRESULT {.winapi, inline.} = self.lpVtbl.GetStatEx(self, guid, pluHi, pluLo)
proc ResetStats*(self: ptr IActiveScriptStats): HRESULT {.winapi, inline.} = self.lpVtbl.ResetStats(self)
proc GetProperty*(self: ptr IActiveScriptProperty, dwProperty: DWORD, pvarIndex: ptr VARIANT, pvarValue: ptr VARIANT): HRESULT {.winapi, inline.} = self.lpVtbl.GetProperty(self, dwProperty, pvarIndex, pvarValue)
proc SetProperty*(self: ptr IActiveScriptProperty, dwProperty: DWORD, pvarIndex: ptr VARIANT, pvarValue: ptr VARIANT): HRESULT {.winapi, inline.} = self.lpVtbl.SetProperty(self, dwProperty, pvarIndex, pvarValue)
proc FireEvent*(self: ptr ITridentEventSink, pstrEvent: LPCOLESTR, pdp: ptr DISPPARAMS, pvarRes: ptr VARIANT, pei: ptr EXCEPINFO): HRESULT {.winapi, inline.} = self.lpVtbl.FireEvent(self, pstrEvent, pdp, pvarRes, pei)
proc CollectGarbage*(self: ptr IActiveScriptGarbageCollector, scriptgctype: SCRIPTGCTYPE): HRESULT {.winapi, inline.} = self.lpVtbl.CollectGarbage(self, scriptgctype)
proc GetSIPOID*(self: ptr IActiveScriptSIPInfo, poid_sip: ptr GUID): HRESULT {.winapi, inline.} = self.lpVtbl.GetSIPOID(self, poid_sip)
proc SendScriptTraceInfo*(self: ptr IActiveScriptSiteTraceInfo, stiEventType: SCRIPTTRACEINFO, guidContextID: GUID, dwScriptContextCookie: DWORD, lScriptStatementStart: LONG, lScriptStatementEnd: LONG, dwReserved: DWORD64): HRESULT {.winapi, inline.} = self.lpVtbl.SendScriptTraceInfo(self, stiEventType, guidContextID, dwScriptContextCookie, lScriptStatementStart, lScriptStatementEnd, dwReserved)
proc StartScriptTracing*(self: ptr IActiveScriptTraceInfo, pSiteTraceInfo: ptr IActiveScriptSiteTraceInfo, guidContextID: GUID): HRESULT {.winapi, inline.} = self.lpVtbl.StartScriptTracing(self, pSiteTraceInfo, guidContextID)
proc StopScriptTracing*(self: ptr IActiveScriptTraceInfo): HRESULT {.winapi, inline.} = self.lpVtbl.StopScriptTracing(self)
proc StrComp*(self: ptr IActiveScriptStringCompare, bszStr1: BSTR, bszStr2: BSTR, iRet: ptr LONG): HRESULT {.winapi, inline.} = self.lpVtbl.StrComp(self, bszStr1, bszStr2, iRet)
proc GetNextLink*(self: ptr IOleUILinkContainerW, dwLink: DWORD): DWORD {.winapi, inline.} = self.lpVtbl.GetNextLink(self, dwLink)
proc SetLinkUpdateOptions*(self: ptr IOleUILinkContainerW, dwLink: DWORD, dwUpdateOpt: DWORD): HRESULT {.winapi, inline.} = self.lpVtbl.SetLinkUpdateOptions(self, dwLink, dwUpdateOpt)
proc GetLinkUpdateOptions*(self: ptr IOleUILinkContainerW, dwLink: DWORD, lpdwUpdateOpt: ptr DWORD): HRESULT {.winapi, inline.} = self.lpVtbl.GetLinkUpdateOptions(self, dwLink, lpdwUpdateOpt)
proc SetLinkSource*(self: ptr IOleUILinkContainerW, dwLink: DWORD, lpszDisplayName: LPWSTR, lenFileName: ULONG, pchEaten: ptr ULONG, fValidateSource: WINBOOL): HRESULT {.winapi, inline.} = self.lpVtbl.SetLinkSource(self, dwLink, lpszDisplayName, lenFileName, pchEaten, fValidateSource)
proc GetLinkSource*(self: ptr IOleUILinkContainerW, dwLink: DWORD, lplpszDisplayName: ptr LPWSTR, lplenFileName: ptr ULONG, lplpszFullLinkType: ptr LPWSTR, lplpszShortLinkType: ptr LPWSTR, lpfSourceAvailable: ptr WINBOOL, lpfIsSelected: ptr WINBOOL): HRESULT {.winapi, inline.} = self.lpVtbl.GetLinkSource(self, dwLink, lplpszDisplayName, lplenFileName, lplpszFullLinkType, lplpszShortLinkType, lpfSourceAvailable, lpfIsSelected)
proc OpenLinkSource*(self: ptr IOleUILinkContainerW, dwLink: DWORD): HRESULT {.winapi, inline.} = self.lpVtbl.OpenLinkSource(self, dwLink)
proc UpdateLink*(self: ptr IOleUILinkContainerW, dwLink: DWORD, fErrorMessage: WINBOOL, fReserved: WINBOOL): HRESULT {.winapi, inline.} = self.lpVtbl.UpdateLink(self, dwLink, fErrorMessage, fReserved)
proc CancelLink*(self: ptr IOleUILinkContainerW, dwLink: DWORD): HRESULT {.winapi, inline.} = self.lpVtbl.CancelLink(self, dwLink)
proc GetNextLink*(self: ptr IOleUILinkContainerA, dwLink: DWORD): DWORD {.winapi, inline.} = self.lpVtbl.GetNextLink(self, dwLink)
proc SetLinkUpdateOptions*(self: ptr IOleUILinkContainerA, dwLink: DWORD, dwUpdateOpt: DWORD): HRESULT {.winapi, inline.} = self.lpVtbl.SetLinkUpdateOptions(self, dwLink, dwUpdateOpt)
proc GetLinkUpdateOptions*(self: ptr IOleUILinkContainerA, dwLink: DWORD, lpdwUpdateOpt: ptr DWORD): HRESULT {.winapi, inline.} = self.lpVtbl.GetLinkUpdateOptions(self, dwLink, lpdwUpdateOpt)
proc SetLinkSource*(self: ptr IOleUILinkContainerA, dwLink: DWORD, lpszDisplayName: LPSTR, lenFileName: ULONG, pchEaten: ptr ULONG, fValidateSource: WINBOOL): HRESULT {.winapi, inline.} = self.lpVtbl.SetLinkSource(self, dwLink, lpszDisplayName, lenFileName, pchEaten, fValidateSource)
proc GetLinkSource*(self: ptr IOleUILinkContainerA, dwLink: DWORD, lplpszDisplayName: ptr LPSTR, lplenFileName: ptr ULONG, lplpszFullLinkType: ptr LPSTR, lplpszShortLinkType: ptr LPSTR, lpfSourceAvailable: ptr WINBOOL, lpfIsSelected: ptr WINBOOL): HRESULT {.winapi, inline.} = self.lpVtbl.GetLinkSource(self, dwLink, lplpszDisplayName, lplenFileName, lplpszFullLinkType, lplpszShortLinkType, lpfSourceAvailable, lpfIsSelected)
proc OpenLinkSource*(self: ptr IOleUILinkContainerA, dwLink: DWORD): HRESULT {.winapi, inline.} = self.lpVtbl.OpenLinkSource(self, dwLink)
proc UpdateLink*(self: ptr IOleUILinkContainerA, dwLink: DWORD, fErrorMessage: WINBOOL, fReserved: WINBOOL): HRESULT {.winapi, inline.} = self.lpVtbl.UpdateLink(self, dwLink, fErrorMessage, fReserved)
proc CancelLink*(self: ptr IOleUILinkContainerA, dwLink: DWORD): HRESULT {.winapi, inline.} = self.lpVtbl.CancelLink(self, dwLink)
proc GetObjectInfo*(self: ptr IOleUIObjInfoW, dwObject: DWORD, lpdwObjSize: ptr DWORD, lplpszLabel: ptr LPWSTR, lplpszType: ptr LPWSTR, lplpszShortType: ptr LPWSTR, lplpszLocation: ptr LPWSTR): HRESULT {.winapi, inline.} = self.lpVtbl.GetObjectInfo(self, dwObject, lpdwObjSize, lplpszLabel, lplpszType, lplpszShortType, lplpszLocation)
proc GetConvertInfo*(self: ptr IOleUIObjInfoW, dwObject: DWORD, lpClassID: ptr CLSID, lpwFormat: ptr WORD, lpConvertDefaultClassID: ptr CLSID, lplpClsidExclude: ptr LPCLSID, lpcClsidExclude: ptr UINT): HRESULT {.winapi, inline.} = self.lpVtbl.GetConvertInfo(self, dwObject, lpClassID, lpwFormat, lpConvertDefaultClassID, lplpClsidExclude, lpcClsidExclude)
proc ConvertObject*(self: ptr IOleUIObjInfoW, dwObject: DWORD, clsidNew: REFCLSID): HRESULT {.winapi, inline.} = self.lpVtbl.ConvertObject(self, dwObject, clsidNew)
proc GetViewInfo*(self: ptr IOleUIObjInfoW, dwObject: DWORD, phMetaPict: ptr HGLOBAL, pdvAspect: ptr DWORD, pnCurrentScale: ptr int32): HRESULT {.winapi, inline.} = self.lpVtbl.GetViewInfo(self, dwObject, phMetaPict, pdvAspect, pnCurrentScale)
proc SetViewInfo*(self: ptr IOleUIObjInfoW, dwObject: DWORD, hMetaPict: HGLOBAL, dvAspect: DWORD, nCurrentScale: int32, bRelativeToOrig: WINBOOL): HRESULT {.winapi, inline.} = self.lpVtbl.SetViewInfo(self, dwObject, hMetaPict, dvAspect, nCurrentScale, bRelativeToOrig)
proc GetObjectInfo*(self: ptr IOleUIObjInfoA, dwObject: DWORD, lpdwObjSize: ptr DWORD, lplpszLabel: ptr LPSTR, lplpszType: ptr LPSTR, lplpszShortType: ptr LPSTR, lplpszLocation: ptr LPSTR): HRESULT {.winapi, inline.} = self.lpVtbl.GetObjectInfo(self, dwObject, lpdwObjSize, lplpszLabel, lplpszType, lplpszShortType, lplpszLocation)
proc GetConvertInfo*(self: ptr IOleUIObjInfoA, dwObject: DWORD, lpClassID: ptr CLSID, lpwFormat: ptr WORD, lpConvertDefaultClassID: ptr CLSID, lplpClsidExclude: ptr LPCLSID, lpcClsidExclude: ptr UINT): HRESULT {.winapi, inline.} = self.lpVtbl.GetConvertInfo(self, dwObject, lpClassID, lpwFormat, lpConvertDefaultClassID, lplpClsidExclude, lpcClsidExclude)
proc ConvertObject*(self: ptr IOleUIObjInfoA, dwObject: DWORD, clsidNew: REFCLSID): HRESULT {.winapi, inline.} = self.lpVtbl.ConvertObject(self, dwObject, clsidNew)
proc GetViewInfo*(self: ptr IOleUIObjInfoA, dwObject: DWORD, phMetaPict: ptr HGLOBAL, pdvAspect: ptr DWORD, pnCurrentScale: ptr int32): HRESULT {.winapi, inline.} = self.lpVtbl.GetViewInfo(self, dwObject, phMetaPict, pdvAspect, pnCurrentScale)
proc SetViewInfo*(self: ptr IOleUIObjInfoA, dwObject: DWORD, hMetaPict: HGLOBAL, dvAspect: DWORD, nCurrentScale: int32, bRelativeToOrig: WINBOOL): HRESULT {.winapi, inline.} = self.lpVtbl.SetViewInfo(self, dwObject, hMetaPict, dvAspect, nCurrentScale, bRelativeToOrig)
...
converter winimConverterIAccessible*(x: ptr IAccessible): ptr IDispatch = cast[ptr IDispatch](x)
converter winimConverterIAccessibleHandler*(x: ptr IAccessibleHandler): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIAccIdentity*(x: ptr IAccIdentity): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIAccPropServer*(x: ptr IAccPropServer): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIAccPropServices*(x: ptr IAccPropServices): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIObjectSafety*(x: ptr IObjectSafety): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIActiveScriptSite*(x: ptr IActiveScriptSite): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIActiveScriptError*(x: ptr IActiveScriptError): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIActiveScriptError64*(x: ptr IActiveScriptError64): ptr IActiveScriptError = cast[ptr IActiveScriptError](x)
converter winimConverterIActiveScriptError64*(x: ptr IActiveScriptError64): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIActiveScriptSiteWindow*(x: ptr IActiveScriptSiteWindow): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIActiveScriptSiteUIControl*(x: ptr IActiveScriptSiteUIControl): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIActiveScriptSiteInterruptPoll*(x: ptr IActiveScriptSiteInterruptPoll): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIActiveScript*(x: ptr IActiveScript): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIActiveScriptParse32*(x: ptr IActiveScriptParse32): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIActiveScriptParse64*(x: ptr IActiveScriptParse64): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIActiveScriptParseProcedureOld32*(x: ptr IActiveScriptParseProcedureOld32): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIActiveScriptParseProcedureOld64*(x: ptr IActiveScriptParseProcedureOld64): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIActiveScriptParseProcedure32*(x: ptr IActiveScriptParseProcedure32): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIActiveScriptParseProcedure64*(x: ptr IActiveScriptParseProcedure64): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIActiveScriptParseProcedure2_32*(x: ptr IActiveScriptParseProcedure2_32): ptr IActiveScriptParseProcedure32 = cast[ptr IActiveScriptParseProcedure32](x)
converter winimConverterIActiveScriptParseProcedure2_32*(x: ptr IActiveScriptParseProcedure2_32): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIActiveScriptParseProcedure2_64*(x: ptr IActiveScriptParseProcedure2_64): ptr IActiveScriptParseProcedure64 = cast[ptr IActiveScriptParseProcedure64](x)
converter winimConverterIActiveScriptParseProcedure2_64*(x: ptr IActiveScriptParseProcedure2_64): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIActiveScriptEncode*(x: ptr IActiveScriptEncode): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIActiveScriptHostEncode*(x: ptr IActiveScriptHostEncode): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIBindEventHandler*(x: ptr IBindEventHandler): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIActiveScriptStats*(x: ptr IActiveScriptStats): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIActiveScriptProperty*(x: ptr IActiveScriptProperty): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterITridentEventSink*(x: ptr ITridentEventSink): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIActiveScriptGarbageCollector*(x: ptr IActiveScriptGarbageCollector): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIActiveScriptSIPInfo*(x: ptr IActiveScriptSIPInfo): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIActiveScriptSiteTraceInfo*(x: ptr IActiveScriptSiteTraceInfo): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIActiveScriptTraceInfo*(x: ptr IActiveScriptTraceInfo): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIActiveScriptStringCompare*(x: ptr IActiveScriptStringCompare): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIOleUILinkContainerW*(x: ptr IOleUILinkContainerW): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIOleUILinkContainerA*(x: ptr IOleUILinkContainerA): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIOleUIObjInfoW*(x: ptr IOleUIObjInfoW): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIOleUIObjInfoA*(x: ptr IOleUIObjInfoA): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIOleUILinkInfoW*(x: ptr IOleUILinkInfoW): ptr IOleUILinkContainerW = cast[ptr IOleUILinkContainerW](x)
converter winimConverterIOleUILinkInfoW*(x: ptr IOleUILinkInfoW): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIOleUILinkInfoA*(x: ptr IOleUILinkInfoA): ptr IOleUILinkContainerA = cast[ptr IOleUILinkContainerA](x)
converter winimConverterIOleUILinkInfoA*(x: ptr IOleUILinkInfoA): ptr IUnknown = cast[ptr IUnknown](x)
when winimUnicode:
  type
