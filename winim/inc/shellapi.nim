...
converter winimConverterIQueryAssociations*(x: ptr IQueryAssociations): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIFolderViewOC*(x: ptr IFolderViewOC): ptr IDispatch = cast[ptr IDispatch](x)
converter winimConverterDShellFolderViewEvents*(x: ptr DShellFolderViewEvents): ptr IDispatch = cast[ptr IDispatch](x)
converter winimConverterDFConstraint*(x: ptr DFConstraint): ptr IDispatch = cast[ptr IDispatch](x)
converter winimConverterFolder*(x: ptr Folder): ptr IDispatch = cast[ptr IDispatch](x)
converter winimConverterFolder2*(x: ptr Folder2): ptr Folder = cast[ptr Folder](x)
converter winimConverterFolder2*(x: ptr Folder2): ptr IDispatch = cast[ptr IDispatch](x)
converter winimConverterFolder3*(x: ptr Folder3): ptr Folder2 = cast[ptr Folder2](x)
converter winimConverterFolder3*(x: ptr Folder3): ptr Folder = cast[ptr Folder](x)
converter winimConverterFolder3*(x: ptr Folder3): ptr IDispatch = cast[ptr IDispatch](x)
converter winimConverterFolderItem*(x: ptr FolderItem): ptr IDispatch = cast[ptr IDispatch](x)
converter winimConverterFolderItem2*(x: ptr FolderItem2): ptr FolderItem = cast[ptr FolderItem](x)
converter winimConverterFolderItem2*(x: ptr FolderItem2): ptr IDispatch = cast[ptr IDispatch](x)
converter winimConverterFolderItems*(x: ptr FolderItems): ptr IDispatch = cast[ptr IDispatch](x)
converter winimConverterFolderItems2*(x: ptr FolderItems2): ptr FolderItems = cast[ptr FolderItems](x)
converter winimConverterFolderItems2*(x: ptr FolderItems2): ptr IDispatch = cast[ptr IDispatch](x)
converter winimConverterFolderItems3*(x: ptr FolderItems3): ptr FolderItems2 = cast[ptr FolderItems2](x)
converter winimConverterFolderItems3*(x: ptr FolderItems3): ptr FolderItems = cast[ptr FolderItems](x)
converter winimConverterFolderItems3*(x: ptr FolderItems3): ptr IDispatch = cast[ptr IDispatch](x)
converter winimConverterFolderItemVerb*(x: ptr FolderItemVerb): ptr IDispatch = cast[ptr IDispatch](x)
converter winimConverterFolderItemVerbs*(x: ptr FolderItemVerbs): ptr IDispatch = cast[ptr IDispatch](x)
converter winimConverterIShellLinkDual*(x: ptr IShellLinkDual): ptr IDispatch = cast[ptr IDispatch](x)
converter winimConverterIShellLinkDual2*(x: ptr IShellLinkDual2): ptr IShellLinkDual = cast[ptr IShellLinkDual](x)
converter winimConverterIShellLinkDual2*(x: ptr IShellLinkDual2): ptr IDispatch = cast[ptr IDispatch](x)
converter winimConverterIShellFolderViewDual*(x: ptr IShellFolderViewDual): ptr IDispatch = cast[ptr IDispatch](x)
converter winimConverterIShellFolderViewDual2*(x: ptr IShellFolderViewDual2): ptr IShellFolderViewDual = cast[ptr IShellFolderViewDual](x)
converter winimConverterIShellFolderViewDual2*(x: ptr IShellFolderViewDual2): ptr IDispatch = cast[ptr IDispatch](x)
converter winimConverterIShellFolderViewDual3*(x: ptr IShellFolderViewDual3): ptr IShellFolderViewDual2 = cast[ptr IShellFolderViewDual2](x)
converter winimConverterIShellFolderViewDual3*(x: ptr IShellFolderViewDual3): ptr IShellFolderViewDual = cast[ptr IShellFolderViewDual](x)
converter winimConverterIShellFolderViewDual3*(x: ptr IShellFolderViewDual3): ptr IDispatch = cast[ptr IDispatch](x)
converter winimConverterIShellDispatch*(x: ptr IShellDispatch): ptr IDispatch = cast[ptr IDispatch](x)
converter winimConverterIShellDispatch2*(x: ptr IShellDispatch2): ptr IShellDispatch = cast[ptr IShellDispatch](x)
converter winimConverterIShellDispatch2*(x: ptr IShellDispatch2): ptr IDispatch = cast[ptr IDispatch](x)
converter winimConverterIShellDispatch3*(x: ptr IShellDispatch3): ptr IShellDispatch2 = cast[ptr IShellDispatch2](x)
converter winimConverterIShellDispatch3*(x: ptr IShellDispatch3): ptr IShellDispatch = cast[ptr IShellDispatch](x)
converter winimConverterIShellDispatch3*(x: ptr IShellDispatch3): ptr IDispatch = cast[ptr IDispatch](x)
converter winimConverterIShellDispatch4*(x: ptr IShellDispatch4): ptr IShellDispatch3 = cast[ptr IShellDispatch3](x)
converter winimConverterIShellDispatch4*(x: ptr IShellDispatch4): ptr IShellDispatch2 = cast[ptr IShellDispatch2](x)
converter winimConverterIShellDispatch4*(x: ptr IShellDispatch4): ptr IShellDispatch = cast[ptr IShellDispatch](x)
converter winimConverterIShellDispatch4*(x: ptr IShellDispatch4): ptr IDispatch = cast[ptr IDispatch](x)
converter winimConverterIShellDispatch5*(x: ptr IShellDispatch5): ptr IShellDispatch4 = cast[ptr IShellDispatch4](x)
converter winimConverterIShellDispatch5*(x: ptr IShellDispatch5): ptr IShellDispatch3 = cast[ptr IShellDispatch3](x)
converter winimConverterIShellDispatch5*(x: ptr IShellDispatch5): ptr IShellDispatch2 = cast[ptr IShellDispatch2](x)
converter winimConverterIShellDispatch5*(x: ptr IShellDispatch5): ptr IShellDispatch = cast[ptr IShellDispatch](x)
converter winimConverterIShellDispatch5*(x: ptr IShellDispatch5): ptr IDispatch = cast[ptr IDispatch](x)
converter winimConverterIShellDispatch6*(x: ptr IShellDispatch6): ptr IShellDispatch5 = cast[ptr IShellDispatch5](x)
converter winimConverterIShellDispatch6*(x: ptr IShellDispatch6): ptr IShellDispatch4 = cast[ptr IShellDispatch4](x)
converter winimConverterIShellDispatch6*(x: ptr IShellDispatch6): ptr IShellDispatch3 = cast[ptr IShellDispatch3](x)
converter winimConverterIShellDispatch6*(x: ptr IShellDispatch6): ptr IShellDispatch2 = cast[ptr IShellDispatch2](x)
converter winimConverterIShellDispatch6*(x: ptr IShellDispatch6): ptr IShellDispatch = cast[ptr IShellDispatch](x)
converter winimConverterIShellDispatch6*(x: ptr IShellDispatch6): ptr IDispatch = cast[ptr IDispatch](x)
converter winimConverterIFileSearchBand*(x: ptr IFileSearchBand): ptr IDispatch = cast[ptr IDispatch](x)
converter winimConverterIWebWizardHost*(x: ptr IWebWizardHost): ptr IDispatch = cast[ptr IDispatch](x)
converter winimConverterINewWDEvents*(x: ptr INewWDEvents): ptr IWebWizardHost = cast[ptr IWebWizardHost](x)
converter winimConverterINewWDEvents*(x: ptr INewWDEvents): ptr IDispatch = cast[ptr IDispatch](x)
converter winimConverterIAutoComplete*(x: ptr IAutoComplete): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIAutoComplete2*(x: ptr IAutoComplete2): ptr IAutoComplete = cast[ptr IAutoComplete](x)
converter winimConverterIAutoComplete2*(x: ptr IAutoComplete2): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIEnumACString*(x: ptr IEnumACString): ptr IEnumString = cast[ptr IEnumString](x)
converter winimConverterIDataObjectAsyncCapability*(x: ptr IDataObjectAsyncCapability): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIObjectArray*(x: ptr IObjectArray): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIObjectCollection*(x: ptr IObjectCollection): ptr IObjectArray = cast[ptr IObjectArray](x)
converter winimConverterIObjectCollection*(x: ptr IObjectCollection): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIContextMenu*(x: ptr IContextMenu): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIContextMenu2*(x: ptr IContextMenu2): ptr IContextMenu = cast[ptr IContextMenu](x)
converter winimConverterIContextMenu2*(x: ptr IContextMenu2): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIContextMenu3*(x: ptr IContextMenu3): ptr IContextMenu2 = cast[ptr IContextMenu2](x)
converter winimConverterIContextMenu3*(x: ptr IContextMenu3): ptr IContextMenu = cast[ptr IContextMenu](x)
converter winimConverterIContextMenu3*(x: ptr IContextMenu3): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIExecuteCommand*(x: ptr IExecuteCommand): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIPersistFolder*(x: ptr IPersistFolder): ptr IPersist = cast[ptr IPersist](x)
converter winimConverterIRunnableTask*(x: ptr IRunnableTask): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIShellTaskScheduler*(x: ptr IShellTaskScheduler): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIQueryCodePage*(x: ptr IQueryCodePage): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIPersistFolder2*(x: ptr IPersistFolder2): ptr IPersistFolder = cast[ptr IPersistFolder](x)
converter winimConverterIPersistFolder2*(x: ptr IPersistFolder2): ptr IPersist = cast[ptr IPersist](x)
converter winimConverterIPersistFolder3*(x: ptr IPersistFolder3): ptr IPersistFolder2 = cast[ptr IPersistFolder2](x)
converter winimConverterIPersistFolder3*(x: ptr IPersistFolder3): ptr IPersistFolder = cast[ptr IPersistFolder](x)
converter winimConverterIPersistFolder3*(x: ptr IPersistFolder3): ptr IPersist = cast[ptr IPersist](x)
converter winimConverterIPersistIDList*(x: ptr IPersistIDList): ptr IPersist = cast[ptr IPersist](x)
converter winimConverterIEnumIDList*(x: ptr IEnumIDList): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIEnumFullIDList*(x: ptr IEnumFullIDList): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIObjectWithFolderEnumMode*(x: ptr IObjectWithFolderEnumMode): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIParseAndCreateItem*(x: ptr IParseAndCreateItem): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIShellFolder*(x: ptr IShellFolder): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIEnumExtraSearch*(x: ptr IEnumExtraSearch): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIShellFolder2*(x: ptr IShellFolder2): ptr IShellFolder = cast[ptr IShellFolder](x)
converter winimConverterIShellFolder2*(x: ptr IShellFolder2): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIFolderViewOptions*(x: ptr IFolderViewOptions): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIShellView*(x: ptr IShellView): ptr IOleWindow = cast[ptr IOleWindow](x)
converter winimConverterIShellView2*(x: ptr IShellView2): ptr IShellView = cast[ptr IShellView](x)
converter winimConverterIShellView2*(x: ptr IShellView2): ptr IOleWindow = cast[ptr IOleWindow](x)
converter winimConverterIShellView3*(x: ptr IShellView3): ptr IShellView2 = cast[ptr IShellView2](x)
converter winimConverterIShellView3*(x: ptr IShellView3): ptr IShellView = cast[ptr IShellView](x)
converter winimConverterIShellView3*(x: ptr IShellView3): ptr IOleWindow = cast[ptr IOleWindow](x)
converter winimConverterIFolderView*(x: ptr IFolderView): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterISearchBoxInfo*(x: ptr ISearchBoxInfo): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIFolderView2*(x: ptr IFolderView2): ptr IFolderView = cast[ptr IFolderView](x)
converter winimConverterIFolderView2*(x: ptr IFolderView2): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIFolderViewSettings*(x: ptr IFolderViewSettings): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIPreviewHandlerVisuals*(x: ptr IPreviewHandlerVisuals): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIVisualProperties*(x: ptr IVisualProperties): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterICommDlgBrowser*(x: ptr ICommDlgBrowser): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterICommDlgBrowser2*(x: ptr ICommDlgBrowser2): ptr ICommDlgBrowser = cast[ptr ICommDlgBrowser](x)
converter winimConverterICommDlgBrowser2*(x: ptr ICommDlgBrowser2): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterICommDlgBrowser3*(x: ptr ICommDlgBrowser3): ptr ICommDlgBrowser2 = cast[ptr ICommDlgBrowser2](x)
converter winimConverterICommDlgBrowser3*(x: ptr ICommDlgBrowser3): ptr ICommDlgBrowser = cast[ptr ICommDlgBrowser](x)
converter winimConverterICommDlgBrowser3*(x: ptr ICommDlgBrowser3): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIColumnManager*(x: ptr IColumnManager): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIFolderFilterSite*(x: ptr IFolderFilterSite): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIFolderFilter*(x: ptr IFolderFilter): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIInputObjectSite*(x: ptr IInputObjectSite): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIInputObject*(x: ptr IInputObject): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIInputObject2*(x: ptr IInputObject2): ptr IInputObject = cast[ptr IInputObject](x)
converter winimConverterIInputObject2*(x: ptr IInputObject2): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIShellIcon*(x: ptr IShellIcon): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIShellBrowser*(x: ptr IShellBrowser): ptr IOleWindow = cast[ptr IOleWindow](x)
converter winimConverterIProfferService*(x: ptr IProfferService): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIShellItem*(x: ptr IShellItem): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIShellItem2*(x: ptr IShellItem2): ptr IShellItem = cast[ptr IShellItem](x)
converter winimConverterIShellItem2*(x: ptr IShellItem2): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIShellItemImageFactory*(x: ptr IShellItemImageFactory): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIUserAccountChangeCallback*(x: ptr IUserAccountChangeCallback): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIEnumShellItems*(x: ptr IEnumShellItems): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterITransferAdviseSink*(x: ptr ITransferAdviseSink): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterITransferSource*(x: ptr ITransferSource): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIEnumResources*(x: ptr IEnumResources): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIShellItemResources*(x: ptr IShellItemResources): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterITransferDestination*(x: ptr ITransferDestination): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIStreamAsync*(x: ptr IStreamAsync): ptr IStream = cast[ptr IStream](x)
converter winimConverterIStreamUnbufferedInfo*(x: ptr IStreamUnbufferedInfo): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIFileOperationProgressSink*(x: ptr IFileOperationProgressSink): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIShellItemArray*(x: ptr IShellItemArray): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIInitializeWithItem*(x: ptr IInitializeWithItem): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIObjectWithSelection*(x: ptr IObjectWithSelection): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIObjectWithBackReferences*(x: ptr IObjectWithBackReferences): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIPropertyUI*(x: ptr IPropertyUI): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterICategoryProvider*(x: ptr ICategoryProvider): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterICategorizer*(x: ptr ICategorizer): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIDropTargetHelper*(x: ptr IDropTargetHelper): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIDragSourceHelper*(x: ptr IDragSourceHelper): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIDragSourceHelper2*(x: ptr IDragSourceHelper2): ptr IDragSourceHelper = cast[ptr IDragSourceHelper](x)
converter winimConverterIDragSourceHelper2*(x: ptr IDragSourceHelper2): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIShellLinkA*(x: ptr IShellLinkA): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIShellLinkW*(x: ptr IShellLinkW): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIShellLinkDataList*(x: ptr IShellLinkDataList): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIResolveShellLink*(x: ptr IResolveShellLink): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIActionProgressDialog*(x: ptr IActionProgressDialog): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIHWEventHandler*(x: ptr IHWEventHandler): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIHWEventHandler2*(x: ptr IHWEventHandler2): ptr IHWEventHandler = cast[ptr IHWEventHandler](x)
converter winimConverterIHWEventHandler2*(x: ptr IHWEventHandler2): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIQueryCancelAutoPlay*(x: ptr IQueryCancelAutoPlay): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIDynamicHWHandler*(x: ptr IDynamicHWHandler): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIActionProgress*(x: ptr IActionProgress): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIShellExtInit*(x: ptr IShellExtInit): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIShellPropSheetExt*(x: ptr IShellPropSheetExt): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIRemoteComputer*(x: ptr IRemoteComputer): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIQueryContinue*(x: ptr IQueryContinue): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIObjectWithCancelEvent*(x: ptr IObjectWithCancelEvent): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIUserNotification*(x: ptr IUserNotification): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIUserNotificationCallback*(x: ptr IUserNotificationCallback): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIUserNotification2*(x: ptr IUserNotification2): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIItemNameLimits*(x: ptr IItemNameLimits): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterISearchFolderItemFactory*(x: ptr ISearchFolderItemFactory): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIExtractImage*(x: ptr IExtractImage): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIExtractImage2*(x: ptr IExtractImage2): ptr IExtractImage = cast[ptr IExtractImage](x)
converter winimConverterIExtractImage2*(x: ptr IExtractImage2): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIThumbnailHandlerFactory*(x: ptr IThumbnailHandlerFactory): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIParentAndItem*(x: ptr IParentAndItem): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIDockingWindow*(x: ptr IDockingWindow): ptr IOleWindow = cast[ptr IOleWindow](x)
converter winimConverterIDeskBand*(x: ptr IDeskBand): ptr IDockingWindow = cast[ptr IDockingWindow](x)
converter winimConverterIDeskBand*(x: ptr IDeskBand): ptr IOleWindow = cast[ptr IOleWindow](x)
converter winimConverterIDeskBandInfo*(x: ptr IDeskBandInfo): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIDeskBand2*(x: ptr IDeskBand2): ptr IDeskBand = cast[ptr IDeskBand](x)
converter winimConverterIDeskBand2*(x: ptr IDeskBand2): ptr IDockingWindow = cast[ptr IDockingWindow](x)
converter winimConverterIDeskBand2*(x: ptr IDeskBand2): ptr IOleWindow = cast[ptr IOleWindow](x)
converter winimConverterITaskbarList*(x: ptr ITaskbarList): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterITaskbarList2*(x: ptr ITaskbarList2): ptr ITaskbarList = cast[ptr ITaskbarList](x)
converter winimConverterITaskbarList2*(x: ptr ITaskbarList2): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterITaskbarList3*(x: ptr ITaskbarList3): ptr ITaskbarList2 = cast[ptr ITaskbarList2](x)
converter winimConverterITaskbarList3*(x: ptr ITaskbarList3): ptr ITaskbarList = cast[ptr ITaskbarList](x)
converter winimConverterITaskbarList3*(x: ptr ITaskbarList3): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterITaskbarList4*(x: ptr ITaskbarList4): ptr ITaskbarList3 = cast[ptr ITaskbarList3](x)
converter winimConverterITaskbarList4*(x: ptr ITaskbarList4): ptr ITaskbarList2 = cast[ptr ITaskbarList2](x)
converter winimConverterITaskbarList4*(x: ptr ITaskbarList4): ptr ITaskbarList = cast[ptr ITaskbarList](x)
converter winimConverterITaskbarList4*(x: ptr ITaskbarList4): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIStartMenuPinnedList*(x: ptr IStartMenuPinnedList): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterICDBurn*(x: ptr ICDBurn): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIWizardSite*(x: ptr IWizardSite): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIWizardExtension*(x: ptr IWizardExtension): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIWebWizardExtension*(x: ptr IWebWizardExtension): ptr IWizardExtension = cast[ptr IWizardExtension](x)
converter winimConverterIWebWizardExtension*(x: ptr IWebWizardExtension): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIPublishingWizard*(x: ptr IPublishingWizard): ptr IWizardExtension = cast[ptr IWizardExtension](x)
converter winimConverterIPublishingWizard*(x: ptr IPublishingWizard): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIFolderViewHost*(x: ptr IFolderViewHost): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIExplorerBrowserEvents*(x: ptr IExplorerBrowserEvents): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIExplorerBrowser*(x: ptr IExplorerBrowser): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIAccessibleObject*(x: ptr IAccessibleObject): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIResultsFolder*(x: ptr IResultsFolder): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIEnumObjects*(x: ptr IEnumObjects): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIOperationsProgressDialog*(x: ptr IOperationsProgressDialog): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIIOCancelInformation*(x: ptr IIOCancelInformation): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIFileOperation*(x: ptr IFileOperation): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIObjectProvider*(x: ptr IObjectProvider): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterINamespaceWalkCB*(x: ptr INamespaceWalkCB): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterINamespaceWalkCB2*(x: ptr INamespaceWalkCB2): ptr INamespaceWalkCB = cast[ptr INamespaceWalkCB](x)
converter winimConverterINamespaceWalkCB2*(x: ptr INamespaceWalkCB2): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterINamespaceWalk*(x: ptr INamespaceWalk): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIAutoCompleteDropDown*(x: ptr IAutoCompleteDropDown): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIBandSite*(x: ptr IBandSite): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIModalWindow*(x: ptr IModalWindow): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterICDBurnExt*(x: ptr ICDBurnExt): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIContextMenuSite*(x: ptr IContextMenuSite): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIEnumReadyCallback*(x: ptr IEnumReadyCallback): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIEnumerableView*(x: ptr IEnumerableView): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIInsertItem*(x: ptr IInsertItem): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIMenuBand*(x: ptr IMenuBand): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIFolderBandPriv*(x: ptr IFolderBandPriv): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIRegTreeItem*(x: ptr IRegTreeItem): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIImageRecompress*(x: ptr IImageRecompress): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIDeskBar*(x: ptr IDeskBar): ptr IOleWindow = cast[ptr IOleWindow](x)
converter winimConverterIMenuPopup*(x: ptr IMenuPopup): ptr IDeskBar = cast[ptr IDeskBar](x)
converter winimConverterIMenuPopup*(x: ptr IMenuPopup): ptr IOleWindow = cast[ptr IOleWindow](x)
converter winimConverterIFileIsInUse*(x: ptr IFileIsInUse): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIFileDialogEvents*(x: ptr IFileDialogEvents): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIFileDialog*(x: ptr IFileDialog): ptr IModalWindow = cast[ptr IModalWindow](x)
converter winimConverterIFileDialog*(x: ptr IFileDialog): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIFileSaveDialog*(x: ptr IFileSaveDialog): ptr IFileDialog = cast[ptr IFileDialog](x)
converter winimConverterIFileSaveDialog*(x: ptr IFileSaveDialog): ptr IModalWindow = cast[ptr IModalWindow](x)
converter winimConverterIFileSaveDialog*(x: ptr IFileSaveDialog): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIFileOpenDialog*(x: ptr IFileOpenDialog): ptr IFileDialog = cast[ptr IFileDialog](x)
converter winimConverterIFileOpenDialog*(x: ptr IFileOpenDialog): ptr IModalWindow = cast[ptr IModalWindow](x)
converter winimConverterIFileOpenDialog*(x: ptr IFileOpenDialog): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIFileDialogCustomize*(x: ptr IFileDialogCustomize): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIFileDialogControlEvents*(x: ptr IFileDialogControlEvents): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIFileDialog2*(x: ptr IFileDialog2): ptr IFileDialog = cast[ptr IFileDialog](x)
converter winimConverterIFileDialog2*(x: ptr IFileDialog2): ptr IModalWindow = cast[ptr IModalWindow](x)
converter winimConverterIFileDialog2*(x: ptr IFileDialog2): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIApplicationAssociationRegistration*(x: ptr IApplicationAssociationRegistration): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIApplicationAssociationRegistrationUI*(x: ptr IApplicationAssociationRegistrationUI): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIDelegateFolder*(x: ptr IDelegateFolder): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIBrowserFrameOptions*(x: ptr IBrowserFrameOptions): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterINewWindowManager*(x: ptr INewWindowManager): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIAttachmentExecute*(x: ptr IAttachmentExecute): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIShellMenuCallback*(x: ptr IShellMenuCallback): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIShellMenu*(x: ptr IShellMenu): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIShellRunDll*(x: ptr IShellRunDll): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIKnownFolder*(x: ptr IKnownFolder): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIKnownFolderManager*(x: ptr IKnownFolderManager): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterISharingConfigurationManager*(x: ptr ISharingConfigurationManager): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIPreviousVersionsInfo*(x: ptr IPreviousVersionsInfo): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIRelatedItem*(x: ptr IRelatedItem): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIIdentityName*(x: ptr IIdentityName): ptr IRelatedItem = cast[ptr IRelatedItem](x)
converter winimConverterIIdentityName*(x: ptr IIdentityName): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIDelegateItem*(x: ptr IDelegateItem): ptr IRelatedItem = cast[ptr IRelatedItem](x)
converter winimConverterIDelegateItem*(x: ptr IDelegateItem): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterICurrentItem*(x: ptr ICurrentItem): ptr IRelatedItem = cast[ptr IRelatedItem](x)
converter winimConverterICurrentItem*(x: ptr ICurrentItem): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterITransferMediumItem*(x: ptr ITransferMediumItem): ptr IRelatedItem = cast[ptr IRelatedItem](x)
converter winimConverterITransferMediumItem*(x: ptr ITransferMediumItem): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIUseToBrowseItem*(x: ptr IUseToBrowseItem): ptr IRelatedItem = cast[ptr IRelatedItem](x)
converter winimConverterIUseToBrowseItem*(x: ptr IUseToBrowseItem): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIDisplayItem*(x: ptr IDisplayItem): ptr IRelatedItem = cast[ptr IRelatedItem](x)
converter winimConverterIDisplayItem*(x: ptr IDisplayItem): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIViewStateIdentityItem*(x: ptr IViewStateIdentityItem): ptr IRelatedItem = cast[ptr IRelatedItem](x)
converter winimConverterIViewStateIdentityItem*(x: ptr IViewStateIdentityItem): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIPreviewItem*(x: ptr IPreviewItem): ptr IRelatedItem = cast[ptr IRelatedItem](x)
converter winimConverterIPreviewItem*(x: ptr IPreviewItem): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIDestinationStreamFactory*(x: ptr IDestinationStreamFactory): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterINewMenuClient*(x: ptr INewMenuClient): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIInitializeWithBindCtx*(x: ptr IInitializeWithBindCtx): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIShellItemFilter*(x: ptr IShellItemFilter): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterINameSpaceTreeControl*(x: ptr INameSpaceTreeControl): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterINameSpaceTreeControl2*(x: ptr INameSpaceTreeControl2): ptr INameSpaceTreeControl = cast[ptr INameSpaceTreeControl](x)
converter winimConverterINameSpaceTreeControl2*(x: ptr INameSpaceTreeControl2): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterINameSpaceTreeControlEvents*(x: ptr INameSpaceTreeControlEvents): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterINameSpaceTreeControlDropHandler*(x: ptr INameSpaceTreeControlDropHandler): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterINameSpaceTreeAccessible*(x: ptr INameSpaceTreeAccessible): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterINameSpaceTreeControlCustomDraw*(x: ptr INameSpaceTreeControlCustomDraw): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterINameSpaceTreeControlFolderCapabilities*(x: ptr INameSpaceTreeControlFolderCapabilities): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIPreviewHandler*(x: ptr IPreviewHandler): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIPreviewHandlerFrame*(x: ptr IPreviewHandlerFrame): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterITrayDeskBand*(x: ptr ITrayDeskBand): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIBandHost*(x: ptr IBandHost): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIExplorerPaneVisibility*(x: ptr IExplorerPaneVisibility): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIContextMenuCB*(x: ptr IContextMenuCB): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIDefaultExtractIconInit*(x: ptr IDefaultExtractIconInit): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIExplorerCommand*(x: ptr IExplorerCommand): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIExplorerCommandState*(x: ptr IExplorerCommandState): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIInitializeCommand*(x: ptr IInitializeCommand): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIEnumExplorerCommand*(x: ptr IEnumExplorerCommand): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIExplorerCommandProvider*(x: ptr IExplorerCommandProvider): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIInitializeNetworkFolder*(x: ptr IInitializeNetworkFolder): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIOpenControlPanel*(x: ptr IOpenControlPanel): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIComputerInfoChangeNotify*(x: ptr IComputerInfoChangeNotify): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIFileSystemBindData*(x: ptr IFileSystemBindData): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIFileSystemBindData2*(x: ptr IFileSystemBindData2): ptr IFileSystemBindData = cast[ptr IFileSystemBindData](x)
converter winimConverterIFileSystemBindData2*(x: ptr IFileSystemBindData2): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterICustomDestinationList*(x: ptr ICustomDestinationList): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIApplicationDestinations*(x: ptr IApplicationDestinations): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIApplicationDocumentLists*(x: ptr IApplicationDocumentLists): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIObjectWithAppUserModelID*(x: ptr IObjectWithAppUserModelID): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIObjectWithProgID*(x: ptr IObjectWithProgID): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIUpdateIDList*(x: ptr IUpdateIDList): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIDesktopGadget*(x: ptr IDesktopGadget): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIDesktopWallpaper*(x: ptr IDesktopWallpaper): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIHomeGroup*(x: ptr IHomeGroup): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIInitializeWithPropertyStore*(x: ptr IInitializeWithPropertyStore): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIOpenSearchSource*(x: ptr IOpenSearchSource): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIShellLibrary*(x: ptr IShellLibrary): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIPlaybackManagerEvents*(x: ptr IPlaybackManagerEvents): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIPlaybackManager*(x: ptr IPlaybackManager): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIDefaultFolderMenuInitialize*(x: ptr IDefaultFolderMenuInitialize): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIApplicationActivationManager*(x: ptr IApplicationActivationManager): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIAssocHandlerInvoker*(x: ptr IAssocHandlerInvoker): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIAssocHandler*(x: ptr IAssocHandler): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIEnumAssocHandlers*(x: ptr IEnumAssocHandlers): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIDataObjectProvider*(x: ptr IDataObjectProvider): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIDataTransferManagerInterop*(x: ptr IDataTransferManagerInterop): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIFrameworkInputPaneHandler*(x: ptr IFrameworkInputPaneHandler): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIFrameworkInputPane*(x: ptr IFrameworkInputPane): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterISearchableApplication*(x: ptr ISearchableApplication): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIAccessibilityDockingServiceCallback*(x: ptr IAccessibilityDockingServiceCallback): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIAccessibilityDockingService*(x: ptr IAccessibilityDockingService): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIAppVisibilityEvents*(x: ptr IAppVisibilityEvents): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIAppVisibility*(x: ptr IAppVisibility): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIPackageExecutionStateChangeNotification*(x: ptr IPackageExecutionStateChangeNotification): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIPackageDebugSettings*(x: ptr IPackageDebugSettings): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIExecuteCommandApplicationHostEnvironment*(x: ptr IExecuteCommandApplicationHostEnvironment): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIExecuteCommandHost*(x: ptr IExecuteCommandHost): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIApplicationDesignModeSettings*(x: ptr IApplicationDesignModeSettings): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIInitializeWithWindow*(x: ptr IInitializeWithWindow): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIHandlerInfo*(x: ptr IHandlerInfo): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIHandlerActivationHost*(x: ptr IHandlerActivationHost): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIExtractIconA*(x: ptr IExtractIconA): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIExtractIconW*(x: ptr IExtractIconW): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIShellIconOverlayIdentifier*(x: ptr IShellIconOverlayIdentifier): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIShellIconOverlayManager*(x: ptr IShellIconOverlayManager): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIShellIconOverlay*(x: ptr IShellIconOverlay): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIShellExecuteHookA*(x: ptr IShellExecuteHookA): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIShellExecuteHookW*(x: ptr IShellExecuteHookW): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIURLSearchHook*(x: ptr IURLSearchHook): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterISearchContext*(x: ptr ISearchContext): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIURLSearchHook2*(x: ptr IURLSearchHook2): ptr IURLSearchHook = cast[ptr IURLSearchHook](x)
converter winimConverterIURLSearchHook2*(x: ptr IURLSearchHook2): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterINewShortcutHookA*(x: ptr INewShortcutHookA): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterINewShortcutHookW*(x: ptr INewShortcutHookW): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterICopyHookA*(x: ptr ICopyHookA): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterICopyHookW*(x: ptr ICopyHookW): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIFileViewerSite*(x: ptr IFileViewerSite): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIFileViewerA*(x: ptr IFileViewerA): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIFileViewerW*(x: ptr IFileViewerW): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIShellDetails*(x: ptr IShellDetails): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIObjMgr*(x: ptr IObjMgr): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterICurrentWorkingDirectory*(x: ptr ICurrentWorkingDirectory): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIACList*(x: ptr IACList): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIACList2*(x: ptr IACList2): ptr IACList = cast[ptr IACList](x)
converter winimConverterIACList2*(x: ptr IACList2): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIProgressDialog*(x: ptr IProgressDialog): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIDockingWindowSite*(x: ptr IDockingWindowSite): ptr IOleWindow = cast[ptr IOleWindow](x)
converter winimConverterIDockingWindowFrame*(x: ptr IDockingWindowFrame): ptr IOleWindow = cast[ptr IOleWindow](x)
converter winimConverterIThumbnailCapture*(x: ptr IThumbnailCapture): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIEnumShellImageStore*(x: ptr IEnumShellImageStore): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIShellImageStore*(x: ptr IShellImageStore): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIShellFolderBand*(x: ptr IShellFolderBand): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIDeskBarClient*(x: ptr IDeskBarClient): ptr IOleWindow = cast[ptr IOleWindow](x)
converter winimConverterIActiveDesktop*(x: ptr IActiveDesktop): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIActiveDesktopP*(x: ptr IActiveDesktopP): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIADesktopP2*(x: ptr IADesktopP2): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIColumnProvider*(x: ptr IColumnProvider): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIShellChangeNotify*(x: ptr IShellChangeNotify): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIQueryInfo*(x: ptr IQueryInfo): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIDefViewFrame*(x: ptr IDefViewFrame): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIDocViewSite*(x: ptr IDocViewSite): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIInitializeObject*(x: ptr IInitializeObject): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIBanneredBar*(x: ptr IBanneredBar): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIShellFolderViewCB*(x: ptr IShellFolderViewCB): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIShellFolderView*(x: ptr IShellFolderView): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterINamedPropertyBag*(x: ptr INamedPropertyBag): ptr IUnknown = cast[ptr IUnknown](x)
when winimUnicode:
  type
    DRAGINFO* = DRAGINFOW
