...
proc GetObject*(self: ptr IRichEditOle, iob: LONG, lpreobject: ptr REOBJECT, dwFlags: DWORD): HRESULT {.winapi, inline.} = self.lpVtbl.GetObject(self, iob, lpreobject, dwFlags)
proc InsertObject*(self: ptr IRichEditOle, lpreobject: ptr REOBJECT): HRESULT {.winapi, inline.} = self.lpVtbl.InsertObject(self, lpreobject)
proc ConvertObject*(self: ptr IRichEditOle, iob: LONG, rclsidNew: REFCLSID, lpstrUserTypeNew: LPCSTR): HRESULT {.winapi, inline.} = self.lpVtbl.ConvertObject(self, iob, rclsidNew, lpstrUserTypeNew)
proc ActivateAs*(self: ptr IRichEditOle, rclsid: REFCLSID, rclsidAs: REFCLSID): HRESULT {.winapi, inline.} = self.lpVtbl.ActivateAs(self, rclsid, rclsidAs)
proc SetHostNames*(self: ptr IRichEditOle, lpstrContainerApp: LPCSTR, lpstrContainerObj: LPCSTR): HRESULT {.winapi, inline.} = self.lpVtbl.SetHostNames(self, lpstrContainerApp, lpstrContainerObj)
proc SetLinkAvailable*(self: ptr IRichEditOle, iob: LONG, fAvailable: WINBOOL): HRESULT {.winapi, inline.} = self.lpVtbl.SetLinkAvailable(self, iob, fAvailable)
proc SetDvaspect*(self: ptr IRichEditOle, iob: LONG, dvaspect: DWORD): HRESULT {.winapi, inline.} = self.lpVtbl.SetDvaspect(self, iob, dvaspect)
proc HandsOffStorage*(self: ptr IRichEditOle, iob: LONG): HRESULT {.winapi, inline.} = self.lpVtbl.HandsOffStorage(self, iob)
proc SaveCompleted*(self: ptr IRichEditOle, iob: LONG, lpstg: LPSTORAGE): HRESULT {.winapi, inline.} = self.lpVtbl.SaveCompleted(self, iob, lpstg)
proc InPlaceDeactivate*(self: ptr IRichEditOle): HRESULT {.winapi, inline.} = self.lpVtbl.InPlaceDeactivate(self)
proc ContextSensitiveHelp*(self: ptr IRichEditOle, fEnterMode: WINBOOL): HRESULT {.winapi, inline.} = self.lpVtbl.ContextSensitiveHelp(self, fEnterMode)
proc GetClipboardData*(self: ptr IRichEditOle, lpchrg: ptr CHARRANGE, reco: DWORD, lplpdataobj: ptr LPDATAOBJECT): HRESULT {.winapi, inline.} = self.lpVtbl.GetClipboardData(self, lpchrg, reco, lplpdataobj)
proc ImportDataObject*(self: ptr IRichEditOle, lpdataobj: LPDATAOBJECT, cf: CLIPFORMAT, hMetaPict: HGLOBAL): HRESULT {.winapi, inline.} = self.lpVtbl.ImportDataObject(self, lpdataobj, cf, hMetaPict)
proc GetNewStorage*(self: ptr IRichEditOleCallback, lplpstg: ptr LPSTORAGE): HRESULT {.winapi, inline.} = self.lpVtbl.GetNewStorage(self, lplpstg)
proc GetInPlaceContext*(self: ptr IRichEditOleCallback, lplpFrame: ptr LPOLEINPLACEFRAME, lplpDoc: ptr LPOLEINPLACEUIWINDOW, lpFrameInfo: LPOLEINPLACEFRAMEINFO): HRESULT {.winapi, inline.} = self.lpVtbl.GetInPlaceContext(self, lplpFrame, lplpDoc, lpFrameInfo)
proc ShowContainerUI*(self: ptr IRichEditOleCallback, fShow: WINBOOL): HRESULT {.winapi, inline.} = self.lpVtbl.ShowContainerUI(self, fShow)
proc QueryInsertObject*(self: ptr IRichEditOleCallback, lpclsid: LPCLSID, lpstg: LPSTORAGE, cp: LONG): HRESULT {.winapi, inline.} = self.lpVtbl.QueryInsertObject(self, lpclsid, lpstg, cp)
proc DeleteObject*(self: ptr IRichEditOleCallback, lpoleobj: LPOLEOBJECT): HRESULT {.winapi, inline.} = self.lpVtbl.DeleteObject(self, lpoleobj)
proc QueryAcceptData*(self: ptr IRichEditOleCallback, lpdataobj: LPDATAOBJECT, lpcfFormat: ptr CLIPFORMAT, reco: DWORD, fReally: WINBOOL, hMetaPict: HGLOBAL): HRESULT {.winapi, inline.} = self.lpVtbl.QueryAcceptData(self, lpdataobj, lpcfFormat, reco, fReally, hMetaPict)
proc ContextSensitiveHelp*(self: ptr IRichEditOleCallback, fEnterMode: WINBOOL): HRESULT {.winapi, inline.} = self.lpVtbl.ContextSensitiveHelp(self, fEnterMode)
