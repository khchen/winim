...
proc CredUIParseUserNameA*(userName: cstring, user: cstring, userBufferSize: ULONG, domain: cstring, domainBufferSize: ULONG): DWORD {.winapi, stdcall, dynlib: "credui", importc.}
...
when winimAnsi:
  ...
  proc CredUIParseUserName*(userName: cstring, user: cstring, userBufferSize: ULONG, domain: cstring, domainBufferSize: ULONG): DWORD {.winapi, stdcall, dynlib: "credui", importc: "CredUIParseUserNameA".}
