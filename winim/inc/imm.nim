...
proc Clone*(self: ptr IEnumInputContext, ppEnum: ptr ptr IEnumInputContext): HRESULT {.winapi, inline.} = self.lpVtbl.Clone(self, ppEnum)
proc Next*(self: ptr IEnumInputContext, ulCount: ULONG, rgInputContext: ptr HIMC, pcFetched: ptr ULONG): HRESULT {.winapi, inline.} = self.lpVtbl.Next(self, ulCount, rgInputContext, pcFetched)
proc Reset*(self: ptr IEnumInputContext): HRESULT {.winapi, inline.} = self.lpVtbl.Reset(self)
proc Skip*(self: ptr IEnumInputContext, ulCount: ULONG): HRESULT {.winapi, inline.} = self.lpVtbl.Skip(self, ulCount)
proc RegisterIME*(self: ptr IActiveIMMRegistrar, rclsid: REFCLSID, lgid: LANGID, pszIconFile: LPCWSTR, pszDesc: LPCWSTR): HRESULT {.winapi, inline.} = self.lpVtbl.RegisterIME(self, rclsid, lgid, pszIconFile, pszDesc)
proc UnregisterIME*(self: ptr IActiveIMMRegistrar, rclsid: REFCLSID): HRESULT {.winapi, inline.} = self.lpVtbl.UnregisterIME(self, rclsid)
proc Start*(self: ptr IActiveIMMMessagePumpOwner): HRESULT {.winapi, inline.} = self.lpVtbl.Start(self)
proc End*(self: ptr IActiveIMMMessagePumpOwner): HRESULT {.winapi, inline.} = self.lpVtbl.End(self)
proc OnTranslateMessage*(self: ptr IActiveIMMMessagePumpOwner, pMsg: ptr MSG): HRESULT {.winapi, inline.} = self.lpVtbl.OnTranslateMessage(self, pMsg)
proc Pause*(self: ptr IActiveIMMMessagePumpOwner, pdwCookie: ptr DWORD): HRESULT {.winapi, inline.} = self.lpVtbl.Pause(self, pdwCookie)
proc Resume*(self: ptr IActiveIMMMessagePumpOwner, dwCookie: DWORD): HRESULT {.winapi, inline.} = self.lpVtbl.Resume(self, dwCookie)
proc AssociateContext*(self: ptr IActiveIMMApp, hWnd: HWND, hIME: HIMC, phPrev: ptr HIMC): HRESULT {.winapi, inline.} = self.lpVtbl.AssociateContext(self, hWnd, hIME, phPrev)
proc ConfigureIMEA*(self: ptr IActiveIMMApp, hKL: HKL, hWnd: HWND, dwMode: DWORD, pData: ptr REGISTERWORDA): HRESULT {.winapi, inline.} = self.lpVtbl.ConfigureIMEA(self, hKL, hWnd, dwMode, pData)
proc ConfigureIMEW*(self: ptr IActiveIMMApp, hKL: HKL, hWnd: HWND, dwMode: DWORD, pData: ptr REGISTERWORDW): HRESULT {.winapi, inline.} = self.lpVtbl.ConfigureIMEW(self, hKL, hWnd, dwMode, pData)
proc CreateContext*(self: ptr IActiveIMMApp, phIMC: ptr HIMC): HRESULT {.winapi, inline.} = self.lpVtbl.CreateContext(self, phIMC)
proc DestroyContext*(self: ptr IActiveIMMApp, hIME: HIMC): HRESULT {.winapi, inline.} = self.lpVtbl.DestroyContext(self, hIME)
proc EnumRegisterWordA*(self: ptr IActiveIMMApp, hKL: HKL, szReading: LPSTR, dwStyle: DWORD, szRegister: LPSTR, pData: LPVOID, pEnum: ptr ptr IEnumRegisterWordA): HRESULT {.winapi, inline.} = self.lpVtbl.EnumRegisterWordA(self, hKL, szReading, dwStyle, szRegister, pData, pEnum)
proc EnumRegisterWordW*(self: ptr IActiveIMMApp, hKL: HKL, szReading: LPWSTR, dwStyle: DWORD, szRegister: LPWSTR, pData: LPVOID, pEnum: ptr ptr IEnumRegisterWordW): HRESULT {.winapi, inline.} = self.lpVtbl.EnumRegisterWordW(self, hKL, szReading, dwStyle, szRegister, pData, pEnum)
proc EscapeA*(self: ptr IActiveIMMApp, hKL: HKL, hIMC: HIMC, uEscape: UINT, pData: LPVOID, plResult: ptr LRESULT): HRESULT {.winapi, inline.} = self.lpVtbl.EscapeA(self, hKL, hIMC, uEscape, pData, plResult)
proc EscapeW*(self: ptr IActiveIMMApp, hKL: HKL, hIMC: HIMC, uEscape: UINT, pData: LPVOID, plResult: ptr LRESULT): HRESULT {.winapi, inline.} = self.lpVtbl.EscapeW(self, hKL, hIMC, uEscape, pData, plResult)
proc GetCandidateListA*(self: ptr IActiveIMMApp, hIMC: HIMC, dwIndex: DWORD, uBufLen: UINT, pCandList: ptr CANDIDATELIST, puCopied: ptr UINT): HRESULT {.winapi, inline.} = self.lpVtbl.GetCandidateListA(self, hIMC, dwIndex, uBufLen, pCandList, puCopied)
proc GetCandidateListW*(self: ptr IActiveIMMApp, hIMC: HIMC, dwIndex: DWORD, uBufLen: UINT, pCandList: ptr CANDIDATELIST, puCopied: ptr UINT): HRESULT {.winapi, inline.} = self.lpVtbl.GetCandidateListW(self, hIMC, dwIndex, uBufLen, pCandList, puCopied)
proc GetCandidateListCountA*(self: ptr IActiveIMMApp, hIMC: HIMC, pdwListSize: ptr DWORD, pdwBufLen: ptr DWORD): HRESULT {.winapi, inline.} = self.lpVtbl.GetCandidateListCountA(self, hIMC, pdwListSize, pdwBufLen)
proc GetCandidateListCountW*(self: ptr IActiveIMMApp, hIMC: HIMC, pdwListSize: ptr DWORD, pdwBufLen: ptr DWORD): HRESULT {.winapi, inline.} = self.lpVtbl.GetCandidateListCountW(self, hIMC, pdwListSize, pdwBufLen)
proc GetCandidateWindow*(self: ptr IActiveIMMApp, hIMC: HIMC, dwIndex: DWORD, pCandidate: ptr CANDIDATEFORM): HRESULT {.winapi, inline.} = self.lpVtbl.GetCandidateWindow(self, hIMC, dwIndex, pCandidate)
proc GetCompositionFontA*(self: ptr IActiveIMMApp, hIMC: HIMC, plf: ptr LOGFONTA): HRESULT {.winapi, inline.} = self.lpVtbl.GetCompositionFontA(self, hIMC, plf)
proc GetCompositionFontW*(self: ptr IActiveIMMApp, hIMC: HIMC, plf: ptr LOGFONTW): HRESULT {.winapi, inline.} = self.lpVtbl.GetCompositionFontW(self, hIMC, plf)
proc GetCompositionStringA*(self: ptr IActiveIMMApp, hIMC: HIMC, dwIndex: DWORD, dwBufLen: DWORD, plCopied: ptr LONG, pBuf: LPVOID): HRESULT {.winapi, inline.} = self.lpVtbl.GetCompositionStringA(self, hIMC, dwIndex, dwBufLen, plCopied, pBuf)
proc GetCompositionStringW*(self: ptr IActiveIMMApp, hIMC: HIMC, dwIndex: DWORD, dwBufLen: DWORD, plCopied: ptr LONG, pBuf: LPVOID): HRESULT {.winapi, inline.} = self.lpVtbl.GetCompositionStringW(self, hIMC, dwIndex, dwBufLen, plCopied, pBuf)
proc GetCompositionWindow*(self: ptr IActiveIMMApp, hIMC: HIMC, pCompForm: ptr COMPOSITIONFORM): HRESULT {.winapi, inline.} = self.lpVtbl.GetCompositionWindow(self, hIMC, pCompForm)
proc GetContext*(self: ptr IActiveIMMApp, hWnd: HWND, phIMC: ptr HIMC): HRESULT {.winapi, inline.} = self.lpVtbl.GetContext(self, hWnd, phIMC)
proc GetConversionListA*(self: ptr IActiveIMMApp, hKL: HKL, hIMC: HIMC, pSrc: LPSTR, uBufLen: UINT, uFlag: UINT, pDst: ptr CANDIDATELIST, puCopied: ptr UINT): HRESULT {.winapi, inline.} = self.lpVtbl.GetConversionListA(self, hKL, hIMC, pSrc, uBufLen, uFlag, pDst, puCopied)
proc GetConversionListW*(self: ptr IActiveIMMApp, hKL: HKL, hIMC: HIMC, pSrc: LPWSTR, uBufLen: UINT, uFlag: UINT, pDst: ptr CANDIDATELIST, puCopied: ptr UINT): HRESULT {.winapi, inline.} = self.lpVtbl.GetConversionListW(self, hKL, hIMC, pSrc, uBufLen, uFlag, pDst, puCopied)
proc GetConversionStatus*(self: ptr IActiveIMMApp, hIMC: HIMC, pfdwConversion: ptr DWORD, pfdwSentence: ptr DWORD): HRESULT {.winapi, inline.} = self.lpVtbl.GetConversionStatus(self, hIMC, pfdwConversion, pfdwSentence)
proc GetDefaultIMEWnd*(self: ptr IActiveIMMApp, hWnd: HWND, phDefWnd: ptr HWND): HRESULT {.winapi, inline.} = self.lpVtbl.GetDefaultIMEWnd(self, hWnd, phDefWnd)
proc GetDescriptionA*(self: ptr IActiveIMMApp, hKL: HKL, uBufLen: UINT, szDescription: LPSTR, puCopied: ptr UINT): HRESULT {.winapi, inline.} = self.lpVtbl.GetDescriptionA(self, hKL, uBufLen, szDescription, puCopied)
proc GetDescriptionW*(self: ptr IActiveIMMApp, hKL: HKL, uBufLen: UINT, szDescription: LPWSTR, puCopied: ptr UINT): HRESULT {.winapi, inline.} = self.lpVtbl.GetDescriptionW(self, hKL, uBufLen, szDescription, puCopied)
proc GetGuideLineA*(self: ptr IActiveIMMApp, hIMC: HIMC, dwIndex: DWORD, dwBufLen: DWORD, pBuf: LPSTR, pdwResult: ptr DWORD): HRESULT {.winapi, inline.} = self.lpVtbl.GetGuideLineA(self, hIMC, dwIndex, dwBufLen, pBuf, pdwResult)
proc GetGuideLineW*(self: ptr IActiveIMMApp, hIMC: HIMC, dwIndex: DWORD, dwBufLen: DWORD, pBuf: LPWSTR, pdwResult: ptr DWORD): HRESULT {.winapi, inline.} = self.lpVtbl.GetGuideLineW(self, hIMC, dwIndex, dwBufLen, pBuf, pdwResult)
proc GetIMEFileNameA*(self: ptr IActiveIMMApp, hKL: HKL, uBufLen: UINT, szFileName: LPSTR, puCopied: ptr UINT): HRESULT {.winapi, inline.} = self.lpVtbl.GetIMEFileNameA(self, hKL, uBufLen, szFileName, puCopied)
proc GetIMEFileNameW*(self: ptr IActiveIMMApp, hKL: HKL, uBufLen: UINT, szFileName: LPWSTR, puCopied: ptr UINT): HRESULT {.winapi, inline.} = self.lpVtbl.GetIMEFileNameW(self, hKL, uBufLen, szFileName, puCopied)
proc GetOpenStatus*(self: ptr IActiveIMMApp, hIMC: HIMC): HRESULT {.winapi, inline.} = self.lpVtbl.GetOpenStatus(self, hIMC)
proc GetProperty*(self: ptr IActiveIMMApp, hKL: HKL, fdwIndex: DWORD, pdwProperty: ptr DWORD): HRESULT {.winapi, inline.} = self.lpVtbl.GetProperty(self, hKL, fdwIndex, pdwProperty)
proc GetRegisterWordStyleA*(self: ptr IActiveIMMApp, hKL: HKL, nItem: UINT, pStyleBuf: ptr STYLEBUFA, puCopied: ptr UINT): HRESULT {.winapi, inline.} = self.lpVtbl.GetRegisterWordStyleA(self, hKL, nItem, pStyleBuf, puCopied)
proc GetRegisterWordStyleW*(self: ptr IActiveIMMApp, hKL: HKL, nItem: UINT, pStyleBuf: ptr STYLEBUFW, puCopied: ptr UINT): HRESULT {.winapi, inline.} = self.lpVtbl.GetRegisterWordStyleW(self, hKL, nItem, pStyleBuf, puCopied)
proc GetStatusWindowPos*(self: ptr IActiveIMMApp, hIMC: HIMC, pptPos: ptr POINT): HRESULT {.winapi, inline.} = self.lpVtbl.GetStatusWindowPos(self, hIMC, pptPos)
proc GetVirtualKey*(self: ptr IActiveIMMApp, hWnd: HWND, puVirtualKey: ptr UINT): HRESULT {.winapi, inline.} = self.lpVtbl.GetVirtualKey(self, hWnd, puVirtualKey)
proc InstallIMEA*(self: ptr IActiveIMMApp, szIMEFileName: LPSTR, szLayoutText: LPSTR, phKL: ptr HKL): HRESULT {.winapi, inline.} = self.lpVtbl.InstallIMEA(self, szIMEFileName, szLayoutText, phKL)
proc InstallIMEW*(self: ptr IActiveIMMApp, szIMEFileName: LPWSTR, szLayoutText: LPWSTR, phKL: ptr HKL): HRESULT {.winapi, inline.} = self.lpVtbl.InstallIMEW(self, szIMEFileName, szLayoutText, phKL)
proc IsIME*(self: ptr IActiveIMMApp, hKL: HKL): HRESULT {.winapi, inline.} = self.lpVtbl.IsIME(self, hKL)
proc IsUIMessageA*(self: ptr IActiveIMMApp, hWndIME: HWND, msg: UINT, wParam: WPARAM, lParam: LPARAM): HRESULT {.winapi, inline.} = self.lpVtbl.IsUIMessageA(self, hWndIME, msg, wParam, lParam)
proc IsUIMessageW*(self: ptr IActiveIMMApp, hWndIME: HWND, msg: UINT, wParam: WPARAM, lParam: LPARAM): HRESULT {.winapi, inline.} = self.lpVtbl.IsUIMessageW(self, hWndIME, msg, wParam, lParam)
proc NotifyIME*(self: ptr IActiveIMMApp, hIMC: HIMC, dwAction: DWORD, dwIndex: DWORD, dwValue: DWORD): HRESULT {.winapi, inline.} = self.lpVtbl.NotifyIME(self, hIMC, dwAction, dwIndex, dwValue)
proc mRegisterWordA*(self: ptr IActiveIMMApp, hKL: HKL, szReading: LPSTR, dwStyle: DWORD, szRegister: LPSTR): HRESULT {.winapi, inline.} = self.lpVtbl.RegisterWordA(self, hKL, szReading, dwStyle, szRegister)
proc mRegisterWordW*(self: ptr IActiveIMMApp, hKL: HKL, szReading: LPWSTR, dwStyle: DWORD, szRegister: LPWSTR): HRESULT {.winapi, inline.} = self.lpVtbl.RegisterWordW(self, hKL, szReading, dwStyle, szRegister)
proc ReleaseContext*(self: ptr IActiveIMMApp, hWnd: HWND, hIMC: HIMC): HRESULT {.winapi, inline.} = self.lpVtbl.ReleaseContext(self, hWnd, hIMC)
proc SetCandidateWindow*(self: ptr IActiveIMMApp, hIMC: HIMC, pCandidate: ptr CANDIDATEFORM): HRESULT {.winapi, inline.} = self.lpVtbl.SetCandidateWindow(self, hIMC, pCandidate)
proc SetCompositionFontA*(self: ptr IActiveIMMApp, hIMC: HIMC, plf: ptr LOGFONTA): HRESULT {.winapi, inline.} = self.lpVtbl.SetCompositionFontA(self, hIMC, plf)
proc SetCompositionFontW*(self: ptr IActiveIMMApp, hIMC: HIMC, plf: ptr LOGFONTW): HRESULT {.winapi, inline.} = self.lpVtbl.SetCompositionFontW(self, hIMC, plf)
proc SetCompositionStringA*(self: ptr IActiveIMMApp, hIMC: HIMC, dwIndex: DWORD, pComp: LPVOID, dwCompLen: DWORD, pRead: LPVOID, dwReadLen: DWORD): HRESULT {.winapi, inline.} = self.lpVtbl.SetCompositionStringA(self, hIMC, dwIndex, pComp, dwCompLen, pRead, dwReadLen)
proc SetCompositionStringW*(self: ptr IActiveIMMApp, hIMC: HIMC, dwIndex: DWORD, pComp: LPVOID, dwCompLen: DWORD, pRead: LPVOID, dwReadLen: DWORD): HRESULT {.winapi, inline.} = self.lpVtbl.SetCompositionStringW(self, hIMC, dwIndex, pComp, dwCompLen, pRead, dwReadLen)
proc SetCompositionWindow*(self: ptr IActiveIMMApp, hIMC: HIMC, pCompForm: ptr COMPOSITIONFORM): HRESULT {.winapi, inline.} = self.lpVtbl.SetCompositionWindow(self, hIMC, pCompForm)
proc SetConversionStatus*(self: ptr IActiveIMMApp, hIMC: HIMC, fdwConversion: DWORD, fdwSentence: DWORD): HRESULT {.winapi, inline.} = self.lpVtbl.SetConversionStatus(self, hIMC, fdwConversion, fdwSentence)
proc SetOpenStatus*(self: ptr IActiveIMMApp, hIMC: HIMC, fOpen: WINBOOL): HRESULT {.winapi, inline.} = self.lpVtbl.SetOpenStatus(self, hIMC, fOpen)
proc SetStatusWindowPos*(self: ptr IActiveIMMApp, hIMC: HIMC, pptPos: ptr POINT): HRESULT {.winapi, inline.} = self.lpVtbl.SetStatusWindowPos(self, hIMC, pptPos)
proc SimulateHotKey*(self: ptr IActiveIMMApp, hWnd: HWND, dwHotKeyID: DWORD): HRESULT {.winapi, inline.} = self.lpVtbl.SimulateHotKey(self, hWnd, dwHotKeyID)
proc UnregisterWordA*(self: ptr IActiveIMMApp, hKL: HKL, szReading: LPSTR, dwStyle: DWORD, szUnregister: LPSTR): HRESULT {.winapi, inline.} = self.lpVtbl.UnregisterWordA(self, hKL, szReading, dwStyle, szUnregister)
proc UnregisterWordW*(self: ptr IActiveIMMApp, hKL: HKL, szReading: LPWSTR, dwStyle: DWORD, szUnregister: LPWSTR): HRESULT {.winapi, inline.} = self.lpVtbl.UnregisterWordW(self, hKL, szReading, dwStyle, szUnregister)
proc Activate*(self: ptr IActiveIMMApp, fRestoreLayout: WINBOOL): HRESULT {.winapi, inline.} = self.lpVtbl.Activate(self, fRestoreLayout)
proc Deactivate*(self: ptr IActiveIMMApp): HRESULT {.winapi, inline.} = self.lpVtbl.Deactivate(self)
proc OnDefWindowProc*(self: ptr IActiveIMMApp, hWnd: HWND, Msg: UINT, wParam: WPARAM, lParam: LPARAM, plResult: ptr LRESULT): HRESULT {.winapi, inline.} = self.lpVtbl.OnDefWindowProc(self, hWnd, Msg, wParam, lParam, plResult)
proc FilterClientWindows*(self: ptr IActiveIMMApp, aaClassList: ptr ATOM, uSize: UINT): HRESULT {.winapi, inline.} = self.lpVtbl.FilterClientWindows(self, aaClassList, uSize)
proc GetCodePageA*(self: ptr IActiveIMMApp, hKL: HKL, uCodePage: ptr UINT): HRESULT {.winapi, inline.} = self.lpVtbl.GetCodePageA(self, hKL, uCodePage)
proc GetLangId*(self: ptr IActiveIMMApp, hKL: HKL, plid: ptr LANGID): HRESULT {.winapi, inline.} = self.lpVtbl.GetLangId(self, hKL, plid)
proc AssociateContextEx*(self: ptr IActiveIMMApp, hWnd: HWND, hIMC: HIMC, dwFlags: DWORD): HRESULT {.winapi, inline.} = self.lpVtbl.AssociateContextEx(self, hWnd, hIMC, dwFlags)
proc DisableIME*(self: ptr IActiveIMMApp, idThread: DWORD): HRESULT {.winapi, inline.} = self.lpVtbl.DisableIME(self, idThread)
proc GetImeMenuItemsA*(self: ptr IActiveIMMApp, hIMC: HIMC, dwFlags: DWORD, dwType: DWORD, pImeParentMenu: ptr IMEMENUITEMINFOA, pImeMenu: ptr IMEMENUITEMINFOA, dwSize: DWORD, pdwResult: ptr DWORD): HRESULT {.winapi, inline.} = self.lpVtbl.GetImeMenuItemsA(self, hIMC, dwFlags, dwType, pImeParentMenu, pImeMenu, dwSize, pdwResult)
proc GetImeMenuItemsW*(self: ptr IActiveIMMApp, hIMC: HIMC, dwFlags: DWORD, dwType: DWORD, pImeParentMenu: ptr IMEMENUITEMINFOW, pImeMenu: ptr IMEMENUITEMINFOW, dwSize: DWORD, pdwResult: ptr DWORD): HRESULT {.winapi, inline.} = self.lpVtbl.GetImeMenuItemsW(self, hIMC, dwFlags, dwType, pImeParentMenu, pImeMenu, dwSize, pdwResult)
proc EnumInputContext*(self: ptr IActiveIMMApp, idThread: DWORD, ppEnum: ptr ptr IEnumInputContext): HRESULT {.winapi, inline.} = self.lpVtbl.EnumInputContext(self, idThread, ppEnum)
proc AssociateContext*(self: ptr IActiveIMMIME, hWnd: HWND, hIME: HIMC, phPrev: ptr HIMC): HRESULT {.winapi, inline.} = self.lpVtbl.AssociateContext(self, hWnd, hIME, phPrev)
proc ConfigureIMEA*(self: ptr IActiveIMMIME, hKL: HKL, hWnd: HWND, dwMode: DWORD, pData: ptr REGISTERWORDA): HRESULT {.winapi, inline.} = self.lpVtbl.ConfigureIMEA(self, hKL, hWnd, dwMode, pData)
proc ConfigureIMEW*(self: ptr IActiveIMMIME, hKL: HKL, hWnd: HWND, dwMode: DWORD, pData: ptr REGISTERWORDW): HRESULT {.winapi, inline.} = self.lpVtbl.ConfigureIMEW(self, hKL, hWnd, dwMode, pData)
proc CreateContext*(self: ptr IActiveIMMIME, phIMC: ptr HIMC): HRESULT {.winapi, inline.} = self.lpVtbl.CreateContext(self, phIMC)
proc DestroyContext*(self: ptr IActiveIMMIME, hIME: HIMC): HRESULT {.winapi, inline.} = self.lpVtbl.DestroyContext(self, hIME)
proc EnumRegisterWordA*(self: ptr IActiveIMMIME, hKL: HKL, szReading: LPSTR, dwStyle: DWORD, szRegister: LPSTR, pData: LPVOID, pEnum: ptr ptr IEnumRegisterWordA): HRESULT {.winapi, inline.} = self.lpVtbl.EnumRegisterWordA(self, hKL, szReading, dwStyle, szRegister, pData, pEnum)
proc EnumRegisterWordW*(self: ptr IActiveIMMIME, hKL: HKL, szReading: LPWSTR, dwStyle: DWORD, szRegister: LPWSTR, pData: LPVOID, pEnum: ptr ptr IEnumRegisterWordW): HRESULT {.winapi, inline.} = self.lpVtbl.EnumRegisterWordW(self, hKL, szReading, dwStyle, szRegister, pData, pEnum)
proc EscapeA*(self: ptr IActiveIMMIME, hKL: HKL, hIMC: HIMC, uEscape: UINT, pData: LPVOID, plResult: ptr LRESULT): HRESULT {.winapi, inline.} = self.lpVtbl.EscapeA(self, hKL, hIMC, uEscape, pData, plResult)
proc EscapeW*(self: ptr IActiveIMMIME, hKL: HKL, hIMC: HIMC, uEscape: UINT, pData: LPVOID, plResult: ptr LRESULT): HRESULT {.winapi, inline.} = self.lpVtbl.EscapeW(self, hKL, hIMC, uEscape, pData, plResult)
proc GetCandidateListA*(self: ptr IActiveIMMIME, hIMC: HIMC, dwIndex: DWORD, uBufLen: UINT, pCandList: ptr CANDIDATELIST, puCopied: ptr UINT): HRESULT {.winapi, inline.} = self.lpVtbl.GetCandidateListA(self, hIMC, dwIndex, uBufLen, pCandList, puCopied)
proc GetCandidateListW*(self: ptr IActiveIMMIME, hIMC: HIMC, dwIndex: DWORD, uBufLen: UINT, pCandList: ptr CANDIDATELIST, puCopied: ptr UINT): HRESULT {.winapi, inline.} = self.lpVtbl.GetCandidateListW(self, hIMC, dwIndex, uBufLen, pCandList, puCopied)
proc GetCandidateListCountA*(self: ptr IActiveIMMIME, hIMC: HIMC, pdwListSize: ptr DWORD, pdwBufLen: ptr DWORD): HRESULT {.winapi, inline.} = self.lpVtbl.GetCandidateListCountA(self, hIMC, pdwListSize, pdwBufLen)
proc GetCandidateListCountW*(self: ptr IActiveIMMIME, hIMC: HIMC, pdwListSize: ptr DWORD, pdwBufLen: ptr DWORD): HRESULT {.winapi, inline.} = self.lpVtbl.GetCandidateListCountW(self, hIMC, pdwListSize, pdwBufLen)
proc GetCandidateWindow*(self: ptr IActiveIMMIME, hIMC: HIMC, dwIndex: DWORD, pCandidate: ptr CANDIDATEFORM): HRESULT {.winapi, inline.} = self.lpVtbl.GetCandidateWindow(self, hIMC, dwIndex, pCandidate)
proc GetCompositionFontA*(self: ptr IActiveIMMIME, hIMC: HIMC, plf: ptr LOGFONTA): HRESULT {.winapi, inline.} = self.lpVtbl.GetCompositionFontA(self, hIMC, plf)
proc GetCompositionFontW*(self: ptr IActiveIMMIME, hIMC: HIMC, plf: ptr LOGFONTW): HRESULT {.winapi, inline.} = self.lpVtbl.GetCompositionFontW(self, hIMC, plf)
proc GetCompositionStringA*(self: ptr IActiveIMMIME, hIMC: HIMC, dwIndex: DWORD, dwBufLen: DWORD, plCopied: ptr LONG, pBuf: LPVOID): HRESULT {.winapi, inline.} = self.lpVtbl.GetCompositionStringA(self, hIMC, dwIndex, dwBufLen, plCopied, pBuf)
proc GetCompositionStringW*(self: ptr IActiveIMMIME, hIMC: HIMC, dwIndex: DWORD, dwBufLen: DWORD, plCopied: ptr LONG, pBuf: LPVOID): HRESULT {.winapi, inline.} = self.lpVtbl.GetCompositionStringW(self, hIMC, dwIndex, dwBufLen, plCopied, pBuf)
proc GetCompositionWindow*(self: ptr IActiveIMMIME, hIMC: HIMC, pCompForm: ptr COMPOSITIONFORM): HRESULT {.winapi, inline.} = self.lpVtbl.GetCompositionWindow(self, hIMC, pCompForm)
proc GetContext*(self: ptr IActiveIMMIME, hWnd: HWND, phIMC: ptr HIMC): HRESULT {.winapi, inline.} = self.lpVtbl.GetContext(self, hWnd, phIMC)
proc GetConversionListA*(self: ptr IActiveIMMIME, hKL: HKL, hIMC: HIMC, pSrc: LPSTR, uBufLen: UINT, uFlag: UINT, pDst: ptr CANDIDATELIST, puCopied: ptr UINT): HRESULT {.winapi, inline.} = self.lpVtbl.GetConversionListA(self, hKL, hIMC, pSrc, uBufLen, uFlag, pDst, puCopied)
proc GetConversionListW*(self: ptr IActiveIMMIME, hKL: HKL, hIMC: HIMC, pSrc: LPWSTR, uBufLen: UINT, uFlag: UINT, pDst: ptr CANDIDATELIST, puCopied: ptr UINT): HRESULT {.winapi, inline.} = self.lpVtbl.GetConversionListW(self, hKL, hIMC, pSrc, uBufLen, uFlag, pDst, puCopied)
proc GetConversionStatus*(self: ptr IActiveIMMIME, hIMC: HIMC, pfdwConversion: ptr DWORD, pfdwSentence: ptr DWORD): HRESULT {.winapi, inline.} = self.lpVtbl.GetConversionStatus(self, hIMC, pfdwConversion, pfdwSentence)
proc GetDefaultIMEWnd*(self: ptr IActiveIMMIME, hWnd: HWND, phDefWnd: ptr HWND): HRESULT {.winapi, inline.} = self.lpVtbl.GetDefaultIMEWnd(self, hWnd, phDefWnd)
proc GetDescriptionA*(self: ptr IActiveIMMIME, hKL: HKL, uBufLen: UINT, szDescription: LPSTR, puCopied: ptr UINT): HRESULT {.winapi, inline.} = self.lpVtbl.GetDescriptionA(self, hKL, uBufLen, szDescription, puCopied)
proc GetDescriptionW*(self: ptr IActiveIMMIME, hKL: HKL, uBufLen: UINT, szDescription: LPWSTR, puCopied: ptr UINT): HRESULT {.winapi, inline.} = self.lpVtbl.GetDescriptionW(self, hKL, uBufLen, szDescription, puCopied)
proc GetGuideLineA*(self: ptr IActiveIMMIME, hIMC: HIMC, dwIndex: DWORD, dwBufLen: DWORD, pBuf: LPSTR, pdwResult: ptr DWORD): HRESULT {.winapi, inline.} = self.lpVtbl.GetGuideLineA(self, hIMC, dwIndex, dwBufLen, pBuf, pdwResult)
proc GetGuideLineW*(self: ptr IActiveIMMIME, hIMC: HIMC, dwIndex: DWORD, dwBufLen: DWORD, pBuf: LPWSTR, pdwResult: ptr DWORD): HRESULT {.winapi, inline.} = self.lpVtbl.GetGuideLineW(self, hIMC, dwIndex, dwBufLen, pBuf, pdwResult)
proc GetIMEFileNameA*(self: ptr IActiveIMMIME, hKL: HKL, uBufLen: UINT, szFileName: LPSTR, puCopied: ptr UINT): HRESULT {.winapi, inline.} = self.lpVtbl.GetIMEFileNameA(self, hKL, uBufLen, szFileName, puCopied)
proc GetIMEFileNameW*(self: ptr IActiveIMMIME, hKL: HKL, uBufLen: UINT, szFileName: LPWSTR, puCopied: ptr UINT): HRESULT {.winapi, inline.} = self.lpVtbl.GetIMEFileNameW(self, hKL, uBufLen, szFileName, puCopied)
proc GetOpenStatus*(self: ptr IActiveIMMIME, hIMC: HIMC): HRESULT {.winapi, inline.} = self.lpVtbl.GetOpenStatus(self, hIMC)
proc GetProperty*(self: ptr IActiveIMMIME, hKL: HKL, fdwIndex: DWORD, pdwProperty: ptr DWORD): HRESULT {.winapi, inline.} = self.lpVtbl.GetProperty(self, hKL, fdwIndex, pdwProperty)
proc GetRegisterWordStyleA*(self: ptr IActiveIMMIME, hKL: HKL, nItem: UINT, pStyleBuf: ptr STYLEBUFA, puCopied: ptr UINT): HRESULT {.winapi, inline.} = self.lpVtbl.GetRegisterWordStyleA(self, hKL, nItem, pStyleBuf, puCopied)
proc GetRegisterWordStyleW*(self: ptr IActiveIMMIME, hKL: HKL, nItem: UINT, pStyleBuf: ptr STYLEBUFW, puCopied: ptr UINT): HRESULT {.winapi, inline.} = self.lpVtbl.GetRegisterWordStyleW(self, hKL, nItem, pStyleBuf, puCopied)
proc GetStatusWindowPos*(self: ptr IActiveIMMIME, hIMC: HIMC, pptPos: ptr POINT): HRESULT {.winapi, inline.} = self.lpVtbl.GetStatusWindowPos(self, hIMC, pptPos)
proc GetVirtualKey*(self: ptr IActiveIMMIME, hWnd: HWND, puVirtualKey: ptr UINT): HRESULT {.winapi, inline.} = self.lpVtbl.GetVirtualKey(self, hWnd, puVirtualKey)
proc InstallIMEA*(self: ptr IActiveIMMIME, szIMEFileName: LPSTR, szLayoutText: LPSTR, phKL: ptr HKL): HRESULT {.winapi, inline.} = self.lpVtbl.InstallIMEA(self, szIMEFileName, szLayoutText, phKL)
proc InstallIMEW*(self: ptr IActiveIMMIME, szIMEFileName: LPWSTR, szLayoutText: LPWSTR, phKL: ptr HKL): HRESULT {.winapi, inline.} = self.lpVtbl.InstallIMEW(self, szIMEFileName, szLayoutText, phKL)
proc IsIME*(self: ptr IActiveIMMIME, hKL: HKL): HRESULT {.winapi, inline.} = self.lpVtbl.IsIME(self, hKL)
proc IsUIMessageA*(self: ptr IActiveIMMIME, hWndIME: HWND, msg: UINT, wParam: WPARAM, lParam: LPARAM): HRESULT {.winapi, inline.} = self.lpVtbl.IsUIMessageA(self, hWndIME, msg, wParam, lParam)
proc IsUIMessageW*(self: ptr IActiveIMMIME, hWndIME: HWND, msg: UINT, wParam: WPARAM, lParam: LPARAM): HRESULT {.winapi, inline.} = self.lpVtbl.IsUIMessageW(self, hWndIME, msg, wParam, lParam)
proc NotifyIME*(self: ptr IActiveIMMIME, hIMC: HIMC, dwAction: DWORD, dwIndex: DWORD, dwValue: DWORD): HRESULT {.winapi, inline.} = self.lpVtbl.NotifyIME(self, hIMC, dwAction, dwIndex, dwValue)
proc mRegisterWordA*(self: ptr IActiveIMMIME, hKL: HKL, szReading: LPSTR, dwStyle: DWORD, szRegister: LPSTR): HRESULT {.winapi, inline.} = self.lpVtbl.RegisterWordA(self, hKL, szReading, dwStyle, szRegister)
proc mRegisterWordW*(self: ptr IActiveIMMIME, hKL: HKL, szReading: LPWSTR, dwStyle: DWORD, szRegister: LPWSTR): HRESULT {.winapi, inline.} = self.lpVtbl.RegisterWordW(self, hKL, szReading, dwStyle, szRegister)
proc ReleaseContext*(self: ptr IActiveIMMIME, hWnd: HWND, hIMC: HIMC): HRESULT {.winapi, inline.} = self.lpVtbl.ReleaseContext(self, hWnd, hIMC)
proc SetCandidateWindow*(self: ptr IActiveIMMIME, hIMC: HIMC, pCandidate: ptr CANDIDATEFORM): HRESULT {.winapi, inline.} = self.lpVtbl.SetCandidateWindow(self, hIMC, pCandidate)
proc SetCompositionFontA*(self: ptr IActiveIMMIME, hIMC: HIMC, plf: ptr LOGFONTA): HRESULT {.winapi, inline.} = self.lpVtbl.SetCompositionFontA(self, hIMC, plf)
proc SetCompositionFontW*(self: ptr IActiveIMMIME, hIMC: HIMC, plf: ptr LOGFONTW): HRESULT {.winapi, inline.} = self.lpVtbl.SetCompositionFontW(self, hIMC, plf)
proc SetCompositionStringA*(self: ptr IActiveIMMIME, hIMC: HIMC, dwIndex: DWORD, pComp: LPVOID, dwCompLen: DWORD, pRead: LPVOID, dwReadLen: DWORD): HRESULT {.winapi, inline.} = self.lpVtbl.SetCompositionStringA(self, hIMC, dwIndex, pComp, dwCompLen, pRead, dwReadLen)
proc SetCompositionStringW*(self: ptr IActiveIMMIME, hIMC: HIMC, dwIndex: DWORD, pComp: LPVOID, dwCompLen: DWORD, pRead: LPVOID, dwReadLen: DWORD): HRESULT {.winapi, inline.} = self.lpVtbl.SetCompositionStringW(self, hIMC, dwIndex, pComp, dwCompLen, pRead, dwReadLen)
proc SetCompositionWindow*(self: ptr IActiveIMMIME, hIMC: HIMC, pCompForm: ptr COMPOSITIONFORM): HRESULT {.winapi, inline.} = self.lpVtbl.SetCompositionWindow(self, hIMC, pCompForm)
proc SetConversionStatus*(self: ptr IActiveIMMIME, hIMC: HIMC, fdwConversion: DWORD, fdwSentence: DWORD): HRESULT {.winapi, inline.} = self.lpVtbl.SetConversionStatus(self, hIMC, fdwConversion, fdwSentence)
proc SetOpenStatus*(self: ptr IActiveIMMIME, hIMC: HIMC, fOpen: WINBOOL): HRESULT {.winapi, inline.} = self.lpVtbl.SetOpenStatus(self, hIMC, fOpen)
proc SetStatusWindowPos*(self: ptr IActiveIMMIME, hIMC: HIMC, pptPos: ptr POINT): HRESULT {.winapi, inline.} = self.lpVtbl.SetStatusWindowPos(self, hIMC, pptPos)
proc SimulateHotKey*(self: ptr IActiveIMMIME, hWnd: HWND, dwHotKeyID: DWORD): HRESULT {.winapi, inline.} = self.lpVtbl.SimulateHotKey(self, hWnd, dwHotKeyID)
proc UnregisterWordA*(self: ptr IActiveIMMIME, hKL: HKL, szReading: LPSTR, dwStyle: DWORD, szUnregister: LPSTR): HRESULT {.winapi, inline.} = self.lpVtbl.UnregisterWordA(self, hKL, szReading, dwStyle, szUnregister)
proc UnregisterWordW*(self: ptr IActiveIMMIME, hKL: HKL, szReading: LPWSTR, dwStyle: DWORD, szUnregister: LPWSTR): HRESULT {.winapi, inline.} = self.lpVtbl.UnregisterWordW(self, hKL, szReading, dwStyle, szUnregister)
proc GenerateMessage*(self: ptr IActiveIMMIME, hIMC: HIMC): HRESULT {.winapi, inline.} = self.lpVtbl.GenerateMessage(self, hIMC)
proc LockIMC*(self: ptr IActiveIMMIME, hIMC: HIMC, ppIMC: ptr ptr INPUTCONTEXT): HRESULT {.winapi, inline.} = self.lpVtbl.LockIMC(self, hIMC, ppIMC)
proc UnlockIMC*(self: ptr IActiveIMMIME, hIMC: HIMC): HRESULT {.winapi, inline.} = self.lpVtbl.UnlockIMC(self, hIMC)
proc GetIMCLockCount*(self: ptr IActiveIMMIME, hIMC: HIMC, pdwLockCount: ptr DWORD): HRESULT {.winapi, inline.} = self.lpVtbl.GetIMCLockCount(self, hIMC, pdwLockCount)
proc CreateIMCC*(self: ptr IActiveIMMIME, dwSize: DWORD, phIMCC: ptr HIMCC): HRESULT {.winapi, inline.} = self.lpVtbl.CreateIMCC(self, dwSize, phIMCC)
proc DestroyIMCC*(self: ptr IActiveIMMIME, hIMCC: HIMCC): HRESULT {.winapi, inline.} = self.lpVtbl.DestroyIMCC(self, hIMCC)
proc LockIMCC*(self: ptr IActiveIMMIME, hIMCC: HIMCC, ppv: ptr pointer): HRESULT {.winapi, inline.} = self.lpVtbl.LockIMCC(self, hIMCC, ppv)
proc UnlockIMCC*(self: ptr IActiveIMMIME, hIMCC: HIMCC): HRESULT {.winapi, inline.} = self.lpVtbl.UnlockIMCC(self, hIMCC)
proc ReSizeIMCC*(self: ptr IActiveIMMIME, hIMCC: HIMCC, dwSize: DWORD, phIMCC: ptr HIMCC): HRESULT {.winapi, inline.} = self.lpVtbl.ReSizeIMCC(self, hIMCC, dwSize, phIMCC)
proc GetIMCCSize*(self: ptr IActiveIMMIME, hIMCC: HIMCC, pdwSize: ptr DWORD): HRESULT {.winapi, inline.} = self.lpVtbl.GetIMCCSize(self, hIMCC, pdwSize)
proc GetIMCCLockCount*(self: ptr IActiveIMMIME, hIMCC: HIMCC, pdwLockCount: ptr DWORD): HRESULT {.winapi, inline.} = self.lpVtbl.GetIMCCLockCount(self, hIMCC, pdwLockCount)
proc GetHotKey*(self: ptr IActiveIMMIME, dwHotKeyID: DWORD, puModifiers: ptr UINT, puVKey: ptr UINT, phKL: ptr HKL): HRESULT {.winapi, inline.} = self.lpVtbl.GetHotKey(self, dwHotKeyID, puModifiers, puVKey, phKL)
proc SetHotKey*(self: ptr IActiveIMMIME, dwHotKeyID: DWORD, uModifiers: UINT, uVKey: UINT, hKL: HKL): HRESULT {.winapi, inline.} = self.lpVtbl.SetHotKey(self, dwHotKeyID, uModifiers, uVKey, hKL)
proc CreateSoftKeyboard*(self: ptr IActiveIMMIME, uType: UINT, hOwner: HWND, x: int32, y: int32, phSoftKbdWnd: ptr HWND): HRESULT {.winapi, inline.} = self.lpVtbl.CreateSoftKeyboard(self, uType, hOwner, x, y, phSoftKbdWnd)
proc DestroySoftKeyboard*(self: ptr IActiveIMMIME, hSoftKbdWnd: HWND): HRESULT {.winapi, inline.} = self.lpVtbl.DestroySoftKeyboard(self, hSoftKbdWnd)
proc ShowSoftKeyboard*(self: ptr IActiveIMMIME, hSoftKbdWnd: HWND, nCmdShow: int32): HRESULT {.winapi, inline.} = self.lpVtbl.ShowSoftKeyboard(self, hSoftKbdWnd, nCmdShow)
proc GetCodePageA*(self: ptr IActiveIMMIME, hKL: HKL, uCodePage: ptr UINT): HRESULT {.winapi, inline.} = self.lpVtbl.GetCodePageA(self, hKL, uCodePage)
proc GetLangId*(self: ptr IActiveIMMIME, hKL: HKL, plid: ptr LANGID): HRESULT {.winapi, inline.} = self.lpVtbl.GetLangId(self, hKL, plid)
proc KeybdEvent*(self: ptr IActiveIMMIME, lgidIME: LANGID, bVk: BYTE, bScan: BYTE, dwFlags: DWORD, dwExtraInfo: DWORD): HRESULT {.winapi, inline.} = self.lpVtbl.KeybdEvent(self, lgidIME, bVk, bScan, dwFlags, dwExtraInfo)
proc LockModal*(self: ptr IActiveIMMIME): HRESULT {.winapi, inline.} = self.lpVtbl.LockModal(self)
proc UnlockModal*(self: ptr IActiveIMMIME): HRESULT {.winapi, inline.} = self.lpVtbl.UnlockModal(self)
proc AssociateContextEx*(self: ptr IActiveIMMIME, hWnd: HWND, hIMC: HIMC, dwFlags: DWORD): HRESULT {.winapi, inline.} = self.lpVtbl.AssociateContextEx(self, hWnd, hIMC, dwFlags)
proc DisableIME*(self: ptr IActiveIMMIME, idThread: DWORD): HRESULT {.winapi, inline.} = self.lpVtbl.DisableIME(self, idThread)
proc GetImeMenuItemsA*(self: ptr IActiveIMMIME, hIMC: HIMC, dwFlags: DWORD, dwType: DWORD, pImeParentMenu: ptr IMEMENUITEMINFOA, pImeMenu: ptr IMEMENUITEMINFOA, dwSize: DWORD, pdwResult: ptr DWORD): HRESULT {.winapi, inline.} = self.lpVtbl.GetImeMenuItemsA(self, hIMC, dwFlags, dwType, pImeParentMenu, pImeMenu, dwSize, pdwResult)
proc GetImeMenuItemsW*(self: ptr IActiveIMMIME, hIMC: HIMC, dwFlags: DWORD, dwType: DWORD, pImeParentMenu: ptr IMEMENUITEMINFOW, pImeMenu: ptr IMEMENUITEMINFOW, dwSize: DWORD, pdwResult: ptr DWORD): HRESULT {.winapi, inline.} = self.lpVtbl.GetImeMenuItemsW(self, hIMC, dwFlags, dwType, pImeParentMenu, pImeMenu, dwSize, pdwResult)
proc EnumInputContext*(self: ptr IActiveIMMIME, idThread: DWORD, ppEnum: ptr ptr IEnumInputContext): HRESULT {.winapi, inline.} = self.lpVtbl.EnumInputContext(self, idThread, ppEnum)
proc RequestMessageA*(self: ptr IActiveIMMIME, hIMC: HIMC, wParam: WPARAM, lParam: LPARAM, plResult: ptr LRESULT): HRESULT {.winapi, inline.} = self.lpVtbl.RequestMessageA(self, hIMC, wParam, lParam, plResult)
proc RequestMessageW*(self: ptr IActiveIMMIME, hIMC: HIMC, wParam: WPARAM, lParam: LPARAM, plResult: ptr LRESULT): HRESULT {.winapi, inline.} = self.lpVtbl.RequestMessageW(self, hIMC, wParam, lParam, plResult)
proc SendIMCA*(self: ptr IActiveIMMIME, hWnd: HWND, uMsg: UINT, wParam: WPARAM, lParam: LPARAM, plResult: ptr LRESULT): HRESULT {.winapi, inline.} = self.lpVtbl.SendIMCA(self, hWnd, uMsg, wParam, lParam, plResult)
proc SendIMCW*(self: ptr IActiveIMMIME, hWnd: HWND, uMsg: UINT, wParam: WPARAM, lParam: LPARAM, plResult: ptr LRESULT): HRESULT {.winapi, inline.} = self.lpVtbl.SendIMCW(self, hWnd, uMsg, wParam, lParam, plResult)
proc IsSleeping*(self: ptr IActiveIMMIME): HRESULT {.winapi, inline.} = self.lpVtbl.IsSleeping(self)
proc Inquire*(self: ptr IActiveIME, dwSystemInfoFlags: DWORD, pIMEInfo: ptr IMEINFO, szWndClass: LPWSTR, pdwPrivate: ptr DWORD): HRESULT {.winapi, inline.} = self.lpVtbl.Inquire(self, dwSystemInfoFlags, pIMEInfo, szWndClass, pdwPrivate)
proc ConversionList*(self: ptr IActiveIME, hIMC: HIMC, szSource: LPWSTR, uFlag: UINT, uBufLen: UINT, pDest: ptr CANDIDATELIST, puCopied: ptr UINT): HRESULT {.winapi, inline.} = self.lpVtbl.ConversionList(self, hIMC, szSource, uFlag, uBufLen, pDest, puCopied)
proc Configure*(self: ptr IActiveIME, hKL: HKL, hWnd: HWND, dwMode: DWORD, pRegisterWord: ptr REGISTERWORDW): HRESULT {.winapi, inline.} = self.lpVtbl.Configure(self, hKL, hWnd, dwMode, pRegisterWord)
proc Destroy*(self: ptr IActiveIME, uReserved: UINT): HRESULT {.winapi, inline.} = self.lpVtbl.Destroy(self, uReserved)
proc Escape*(self: ptr IActiveIME, hIMC: HIMC, uEscape: UINT, pData: pointer, plResult: ptr LRESULT): HRESULT {.winapi, inline.} = self.lpVtbl.Escape(self, hIMC, uEscape, pData, plResult)
proc SetActiveContext*(self: ptr IActiveIME, hIMC: HIMC, fFlag: WINBOOL): HRESULT {.winapi, inline.} = self.lpVtbl.SetActiveContext(self, hIMC, fFlag)
proc ProcessKey*(self: ptr IActiveIME, hIMC: HIMC, uVirKey: UINT, lParam: DWORD, pbKeyState: ptr BYTE): HRESULT {.winapi, inline.} = self.lpVtbl.ProcessKey(self, hIMC, uVirKey, lParam, pbKeyState)
proc Notify*(self: ptr IActiveIME, hIMC: HIMC, dwAction: DWORD, dwIndex: DWORD, dwValue: DWORD): HRESULT {.winapi, inline.} = self.lpVtbl.Notify(self, hIMC, dwAction, dwIndex, dwValue)
proc Select*(self: ptr IActiveIME, hIMC: HIMC, fSelect: WINBOOL): HRESULT {.winapi, inline.} = self.lpVtbl.Select(self, hIMC, fSelect)
proc SetCompositionString*(self: ptr IActiveIME, hIMC: HIMC, dwIndex: DWORD, pComp: pointer, dwCompLen: DWORD, pRead: pointer, dwReadLen: DWORD): HRESULT {.winapi, inline.} = self.lpVtbl.SetCompositionString(self, hIMC, dwIndex, pComp, dwCompLen, pRead, dwReadLen)
proc ToAsciiEx*(self: ptr IActiveIME, uVirKey: UINT, uScanCode: UINT, pbKeyState: ptr BYTE, fuState: UINT, hIMC: HIMC, pdwTransBuf: ptr DWORD, puSize: ptr UINT): HRESULT {.winapi, inline.} = self.lpVtbl.ToAsciiEx(self, uVirKey, uScanCode, pbKeyState, fuState, hIMC, pdwTransBuf, puSize)
proc mRegisterWord*(self: ptr IActiveIME, szReading: LPWSTR, dwStyle: DWORD, szString: LPWSTR): HRESULT {.winapi, inline.} = self.lpVtbl.RegisterWord(self, szReading, dwStyle, szString)
proc UnregisterWord*(self: ptr IActiveIME, szReading: LPWSTR, dwStyle: DWORD, szString: LPWSTR): HRESULT {.winapi, inline.} = self.lpVtbl.UnregisterWord(self, szReading, dwStyle, szString)
proc GetRegisterWordStyle*(self: ptr IActiveIME, nItem: UINT, pStyleBuf: ptr STYLEBUFW, puBufSize: ptr UINT): HRESULT {.winapi, inline.} = self.lpVtbl.GetRegisterWordStyle(self, nItem, pStyleBuf, puBufSize)
proc EnumRegisterWord*(self: ptr IActiveIME, szReading: LPWSTR, dwStyle: DWORD, szRegister: LPWSTR, pData: LPVOID, ppEnum: ptr ptr IEnumRegisterWordW): HRESULT {.winapi, inline.} = self.lpVtbl.EnumRegisterWord(self, szReading, dwStyle, szRegister, pData, ppEnum)
proc GetCodePageA*(self: ptr IActiveIME, uCodePage: ptr UINT): HRESULT {.winapi, inline.} = self.lpVtbl.GetCodePageA(self, uCodePage)
proc GetLangId*(self: ptr IActiveIME, plid: ptr LANGID): HRESULT {.winapi, inline.} = self.lpVtbl.GetLangId(self, plid)
proc Sleep*(self: ptr IActiveIME2): HRESULT {.winapi, inline.} = self.lpVtbl.Sleep(self)
proc Unsleep*(self: ptr IActiveIME2, fDead: WINBOOL): HRESULT {.winapi, inline.} = self.lpVtbl.Unsleep(self, fDead)
proc Clone*(self: ptr IEnumRegisterWordA, ppEnum: ptr ptr IEnumRegisterWordA): HRESULT {.winapi, inline.} = self.lpVtbl.Clone(self, ppEnum)
proc Next*(self: ptr IEnumRegisterWordA, ulCount: ULONG, rgRegisterWord: ptr REGISTERWORDA, pcFetched: ptr ULONG): HRESULT {.winapi, inline.} = self.lpVtbl.Next(self, ulCount, rgRegisterWord, pcFetched)
proc Reset*(self: ptr IEnumRegisterWordA): HRESULT {.winapi, inline.} = self.lpVtbl.Reset(self)
proc Skip*(self: ptr IEnumRegisterWordA, ulCount: ULONG): HRESULT {.winapi, inline.} = self.lpVtbl.Skip(self, ulCount)
proc Clone*(self: ptr IEnumRegisterWordW, ppEnum: ptr ptr IEnumRegisterWordW): HRESULT {.winapi, inline.} = self.lpVtbl.Clone(self, ppEnum)
proc Next*(self: ptr IEnumRegisterWordW, ulCount: ULONG, rgRegisterWord: ptr REGISTERWORDW, pcFetched: ptr ULONG): HRESULT {.winapi, inline.} = self.lpVtbl.Next(self, ulCount, rgRegisterWord, pcFetched)
proc Reset*(self: ptr IEnumRegisterWordW): HRESULT {.winapi, inline.} = self.lpVtbl.Reset(self)
proc Skip*(self: ptr IEnumRegisterWordW, ulCount: ULONG): HRESULT {.winapi, inline.} = self.lpVtbl.Skip(self, ulCount)
converter winimConverterIEnumInputContext*(x: ptr IEnumInputContext): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIActiveIMMRegistrar*(x: ptr IActiveIMMRegistrar): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIActiveIMMMessagePumpOwner*(x: ptr IActiveIMMMessagePumpOwner): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIActiveIMMApp*(x: ptr IActiveIMMApp): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIActiveIMMIME*(x: ptr IActiveIMMIME): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIActiveIME*(x: ptr IActiveIME): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIActiveIME2*(x: ptr IActiveIME2): ptr IActiveIME = cast[ptr IActiveIME](x)
converter winimConverterIActiveIME2*(x: ptr IActiveIME2): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIEnumRegisterWordA*(x: ptr IEnumRegisterWordA): ptr IUnknown = cast[ptr IUnknown](x)
converter winimConverterIEnumRegisterWordW*(x: ptr IEnumRegisterWordW): ptr IUnknown = cast[ptr IUnknown](x)
when winimUnicode:
  type
