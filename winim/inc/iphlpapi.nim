...
const
  ...
  NDIS_PF_FUNCTION_ID* = USHORT(-1)
  NDIS_INVALID_VF_FUNCTION_ID* = USHORT(-1)
  ...
  GUID_NDIS_NDK_CAPABILITIES* = DEFINE_GUID(0x7969ba4d'i32, 0xdd80, 0x4bc7, [0xb3'u8, 0xe6, 0x68, 0x04, 0x39, 0x97, 0xe5, 0x19])
  GUID_NDIS_NDK_STATE* = DEFINE_GUID(0x530c69c9'i32, 0x2f51, 0x49de, [0xa1'u8, 0xaf, 0x08, 0x8d, 0x54, 0xff, 0xa4, 0x74])
