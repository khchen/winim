...
proc `<<`*[I, T: char](a: ptr array[I, T]|var array[I, T], s: mstring|string) =
...
proc `<<`*[I, T: char](s: var mstring|var string, a: ptr array[I, T]|array[I, T]) =
...
proc `<<`*(p: ptr char|cstring, s: mstring|string) =
  ## Fill buffer by string.
